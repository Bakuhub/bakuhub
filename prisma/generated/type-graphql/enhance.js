...
const relationResolversInfo = {
    Account: ["user"],
    Session: ["user"],
    User: ["accounts", "sessions", "premises", "threads", "visions", "timelines", "ReactionOnThreads", "ReactionOnTimelines", "ReactionOnVisions", "votesOnVision", "votesOnTimeline", "votesOnPremise", "votesOnThread"],
    Premise: ["author", "vision", "premisesOnTimelines", "tagsOnPremises", "threadsOnPremise", "votesOnPremise"],
    ...
    Timeline: ["author", "premisesOnTimelines", "tagsOnTimelines", "threadsOnTimeline", "ReactionOnTimelines", "votesOnTimeline"],
...
const modelsInfo = {
    ...
    VotesOnVision: ["userId", "visionId", "vote", "createdAt"],
    VotesOnTimeline: ["userId", "timelineId", "vote", "createdAt"],
    VotesOnPremise: ["userId", "premiseId", "vote", "createdAt"],
    VotesOnThread: ["userId", "threadId", "vote", "createdAt"]
};
...
const outputsInfo = {
    ...
    VotesOnVisionGroupBy: ["userId", "visionId", "vote", "createdAt", "_count", "_avg", "_sum", "_min", "_max"],
    AggregateVotesOnTimeline: ["_count", "_avg", "_sum", "_min", "_max"],
    VotesOnTimelineGroupBy: ["userId", "timelineId", "vote", "createdAt", "_count", "_avg", "_sum", "_min", "_max"],
    AggregateVotesOnPremise: ["_count", "_avg", "_sum", "_min", "_max"],
    VotesOnPremiseGroupBy: ["userId", "premiseId", "vote", "createdAt", "_count", "_avg", "_sum", "_min", "_max"],
    AggregateVotesOnThread: ["_count", "_avg", "_sum", "_min", "_max"],
    VotesOnThreadGroupBy: ["userId", "threadId", "vote", "createdAt", "_count", "_avg", "_sum", "_min", "_max"],
    ...
    UserCount: ["accounts", "sessions", "premises", "threads", "visions", "timelines", "ReactionOnThreads", "ReactionOnTimelines", "ReactionOnVisions", "votesOnVision", "votesOnTimeline", "votesOnPremise", "votesOnThread"],
    ...
    PremiseCount: ["vision", "premisesOnTimelines", "tagsOnPremises", "threadsOnPremise", "votesOnPremise"],
    ...
    TimelineCount: ["premisesOnTimelines", "tagsOnTimelines", "threadsOnTimeline", "ReactionOnTimelines", "votesOnTimeline"],
    ...
    VotesOnVisionCountAggregate: ["userId", "visionId", "vote", "createdAt", "_all"],
    VotesOnVisionAvgAggregate: ["vote"],
    VotesOnVisionSumAggregate: ["vote"],
    VotesOnVisionMinAggregate: ["userId", "visionId", "vote", "createdAt"],
    VotesOnVisionMaxAggregate: ["userId", "visionId", "vote", "createdAt"],
    VotesOnTimelineCountAggregate: ["userId", "timelineId", "vote", "createdAt", "_all"],
    VotesOnTimelineAvgAggregate: ["vote"],
    VotesOnTimelineSumAggregate: ["vote"],
    VotesOnTimelineMinAggregate: ["userId", "timelineId", "vote", "createdAt"],
    VotesOnTimelineMaxAggregate: ["userId", "timelineId", "vote", "createdAt"],
    VotesOnPremiseCountAggregate: ["userId", "premiseId", "vote", "createdAt", "_all"],
    VotesOnPremiseAvgAggregate: ["vote"],
    VotesOnPremiseSumAggregate: ["vote"],
    VotesOnPremiseMinAggregate: ["userId", "premiseId", "vote", "createdAt"],
    VotesOnPremiseMaxAggregate: ["userId", "premiseId", "vote", "createdAt"],
    VotesOnThreadCountAggregate: ["userId", "threadId", "vote", "createdAt", "_all"],
    VotesOnThreadAvgAggregate: ["vote"],
    VotesOnThreadSumAggregate: ["vote"],
    VotesOnThreadMinAggregate: ["userId", "threadId", "vote", "createdAt"],
    VotesOnThreadMaxAggregate: ["userId", "threadId", "vote", "createdAt"]
};
...
const inputsInfo = {
    ...
    UserWhereInput: ["AND", "OR", "NOT", "id", "name", "email", "emailVerified", "updatedAt", "image", "accounts", "sessions", "premises", "threads", "visions", "timelines", "ReactionOnThreads", "ReactionOnTimelines", "ReactionOnVisions", "votesOnVision", "votesOnTimeline", "votesOnPremise", "votesOnThread"],
    UserOrderByWithRelationInput: ["id", "name", "email", "emailVerified", "updatedAt", "image", "accounts", "sessions", "premises", "threads", "visions", "timelines", "ReactionOnThreads", "ReactionOnTimelines", "ReactionOnVisions", "votesOnVision", "votesOnTimeline", "votesOnPremise", "votesOnThread"],
    ...
    PremiseWhereInput: ["AND", "OR", "NOT", "id", "title", "createdAt", "updatedAt", "status", "author", "authorId", "vision", "premisesOnTimelines", "tagsOnPremises", "threadsOnPremise", "votesOnPremise"],
    PremiseOrderByWithRelationInput: ["id", "title", "createdAt", "updatedAt", "status", "author", "authorId", "vision", "premisesOnTimelines", "tagsOnPremises", "threadsOnPremise", "votesOnPremise"],
    ...
    TimelineWhereInput: ["AND", "OR", "NOT", "id", "title", "description", "status", "author", "authorId", "premisesOnTimelines", "tagsOnTimelines", "threadsOnTimeline", "ReactionOnTimelines", "votesOnTimeline"],
    TimelineOrderByWithRelationInput: ["id", "title", "description", "status", "author", "authorId", "premisesOnTimelines", "tagsOnTimelines", "threadsOnTimeline", "ReactionOnTimelines", "votesOnTimeline"],
    ...
    ThreadWhereInput: ["AND", "OR", "NOT", "id", "title", "activityDate", "description", "createdAt", "reference", "author", "authorId", "parentThreadId", "parentThread", "childThreads", "threadsOnPremise", "threadsOnTimeline", "threadsOnVision", "threadsOnMergeRequest", "ReactionOnThreads", "votesOnThread"],
    ThreadOrderByWithRelationInput: ["id", "title", "activityDate", "description", "createdAt", "reference", "author", "authorId", "parentThreadId", "parentThread", "childThreads", "threadsOnPremise", "threadsOnTimeline", "threadsOnVision", "threadsOnMergeRequest", "ReactionOnThreads", "votesOnThread"],
    ...
    VotesOnVisionWhereInput: ["AND", "OR", "NOT", "user", "userId", "vision", "visionId", "vote", "createdAt"],
    VotesOnVisionOrderByWithRelationInput: ["user", "userId", "vision", "visionId", "vote", "createdAt"],
    VotesOnVisionWhereUniqueInput: ["userId_visionId"],
    VotesOnVisionOrderByWithAggregationInput: ["userId", "visionId", "vote", "createdAt", "_count", "_avg", "_max", "_min", "_sum"],
    VotesOnVisionScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "userId", "visionId", "vote", "createdAt"],
    VotesOnTimelineWhereInput: ["AND", "OR", "NOT", "user", "userId", "timeline", "timelineId", "vote", "createdAt"],
    VotesOnTimelineOrderByWithRelationInput: ["user", "userId", "timeline", "timelineId", "vote", "createdAt"],
    VotesOnTimelineWhereUniqueInput: ["userId_timelineId"],
    VotesOnTimelineOrderByWithAggregationInput: ["userId", "timelineId", "vote", "createdAt", "_count", "_avg", "_max", "_min", "_sum"],
    VotesOnTimelineScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "userId", "timelineId", "vote", "createdAt"],
    VotesOnPremiseWhereInput: ["AND", "OR", "NOT", "user", "userId", "premise", "premiseId", "vote", "createdAt"],
    VotesOnPremiseOrderByWithRelationInput: ["user", "userId", "premise", "premiseId", "vote", "createdAt"],
    VotesOnPremiseWhereUniqueInput: ["userId_premiseId"],
    VotesOnPremiseOrderByWithAggregationInput: ["userId", "premiseId", "vote", "createdAt", "_count", "_avg", "_max", "_min", "_sum"],
    VotesOnPremiseScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "userId", "premiseId", "vote", "createdAt"],
    VotesOnThreadWhereInput: ["AND", "OR", "NOT", "user", "userId", "thread", "threadId", "vote", "createdAt"],
    VotesOnThreadOrderByWithRelationInput: ["user", "userId", "thread", "threadId", "vote", "createdAt"],
    VotesOnThreadWhereUniqueInput: ["userId_threadId"],
    VotesOnThreadOrderByWithAggregationInput: ["userId", "threadId", "vote", "createdAt", "_count", "_avg", "_max", "_min", "_sum"],
    VotesOnThreadScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "userId", "threadId", "vote", "createdAt"],
    ...
    UserCreateInput: ["id", "name", "email", "emailVerified", "updatedAt", "image", "accounts", "sessions", "premises", "threads", "visions", "timelines", "ReactionOnThreads", "ReactionOnTimelines", "ReactionOnVisions", "votesOnVision", "votesOnTimeline", "votesOnPremise", "votesOnThread"],
    UserUpdateInput: ["id", "name", "email", "emailVerified", "updatedAt", "image", "accounts", "sessions", "premises", "threads", "visions", "timelines", "ReactionOnThreads", "ReactionOnTimelines", "ReactionOnVisions", "votesOnVision", "votesOnTimeline", "votesOnPremise", "votesOnThread"],
    ...
    PremiseCreateInput: ["id", "title", "createdAt", "updatedAt", "status", "author", "vision", "premisesOnTimelines", "tagsOnPremises", "threadsOnPremise", "votesOnPremise"],
    PremiseUpdateInput: ["id", "title", "createdAt", "updatedAt", "status", "author", "vision", "premisesOnTimelines", "tagsOnPremises", "threadsOnPremise", "votesOnPremise"],
    ...
    TimelineCreateInput: ["id", "title", "description", "status", "author", "premisesOnTimelines", "tagsOnTimelines", "threadsOnTimeline", "ReactionOnTimelines", "votesOnTimeline"],
    TimelineUpdateInput: ["id", "title", "description", "status", "author", "premisesOnTimelines", "tagsOnTimelines", "threadsOnTimeline", "ReactionOnTimelines", "votesOnTimeline"],
    ...
    ThreadCreateInput: ["id", "title", "activityDate", "description", "createdAt", "reference", "author", "parentThread", "childThreads", "threadsOnPremise", "threadsOnTimeline", "threadsOnVision", "threadsOnMergeRequest", "ReactionOnThreads", "votesOnThread"],
    ThreadUpdateInput: ["id", "title", "activityDate", "description", "createdAt", "reference", "author", "parentThread", "childThreads", "threadsOnPremise", "threadsOnTimeline", "threadsOnVision", "threadsOnMergeRequest", "ReactionOnThreads", "votesOnThread"],
    ...
    VotesOnVisionCreateInput: ["user", "vision", "vote", "createdAt"],
    VotesOnVisionUpdateInput: ["user", "vision", "vote", "createdAt"],
    VotesOnVisionCreateManyInput: ["userId", "visionId", "vote", "createdAt"],
    VotesOnVisionUpdateManyMutationInput: ["vote", "createdAt"],
    VotesOnTimelineCreateInput: ["user", "timeline", "vote", "createdAt"],
    VotesOnTimelineUpdateInput: ["user", "timeline", "vote", "createdAt"],
    VotesOnTimelineCreateManyInput: ["userId", "timelineId", "vote", "createdAt"],
    VotesOnTimelineUpdateManyMutationInput: ["vote", "createdAt"],
    VotesOnPremiseCreateInput: ["user", "premise", "vote", "createdAt"],
    VotesOnPremiseUpdateInput: ["user", "premise", "vote", "createdAt"],
    VotesOnPremiseCreateManyInput: ["userId", "premiseId", "vote", "createdAt"],
    VotesOnPremiseUpdateManyMutationInput: ["vote", "createdAt"],
    VotesOnThreadCreateInput: ["user", "thread", "vote", "createdAt"],
    VotesOnThreadUpdateInput: ["user", "thread", "vote", "createdAt"],
    VotesOnThreadCreateManyInput: ["userId", "threadId", "vote", "createdAt"],
    VotesOnThreadUpdateManyMutationInput: ["vote", "createdAt"],
    ...
    VotesOnVisionCountOrderByAggregateInput: ["userId", "visionId", "vote", "createdAt"],
    VotesOnVisionAvgOrderByAggregateInput: ["vote"],
    VotesOnVisionMaxOrderByAggregateInput: ["userId", "visionId", "vote", "createdAt"],
    VotesOnVisionMinOrderByAggregateInput: ["userId", "visionId", "vote", "createdAt"],
    VotesOnVisionSumOrderByAggregateInput: ["vote"],
    VotesOnTimelineUserIdTimelineIdCompoundUniqueInput: ["userId", "timelineId"],
    VotesOnTimelineCountOrderByAggregateInput: ["userId", "timelineId", "vote", "createdAt"],
    VotesOnTimelineAvgOrderByAggregateInput: ["vote"],
    VotesOnTimelineMaxOrderByAggregateInput: ["userId", "timelineId", "vote", "createdAt"],
    VotesOnTimelineMinOrderByAggregateInput: ["userId", "timelineId", "vote", "createdAt"],
    VotesOnTimelineSumOrderByAggregateInput: ["vote"],
    VotesOnPremiseUserIdPremiseIdCompoundUniqueInput: ["userId", "premiseId"],
    VotesOnPremiseCountOrderByAggregateInput: ["userId", "premiseId", "vote", "createdAt"],
    VotesOnPremiseAvgOrderByAggregateInput: ["vote"],
    VotesOnPremiseMaxOrderByAggregateInput: ["userId", "premiseId", "vote", "createdAt"],
    VotesOnPremiseMinOrderByAggregateInput: ["userId", "premiseId", "vote", "createdAt"],
    VotesOnPremiseSumOrderByAggregateInput: ["vote"],
    VotesOnThreadUserIdThreadIdCompoundUniqueInput: ["userId", "threadId"],
    VotesOnThreadCountOrderByAggregateInput: ["userId", "threadId", "vote", "createdAt"],
    VotesOnThreadAvgOrderByAggregateInput: ["vote"],
    VotesOnThreadMaxOrderByAggregateInput: ["userId", "threadId", "vote", "createdAt"],
    VotesOnThreadMinOrderByAggregateInput: ["userId", "threadId", "vote", "createdAt"],
    ...
    UserCreateWithoutAccountsInput: ["id", "name", "email", "emailVerified", "updatedAt", "image", "sessions", "premises", "threads", "visions", "timelines", "ReactionOnThreads", "ReactionOnTimelines", "ReactionOnVisions", "votesOnVision", "votesOnTimeline", "votesOnPremise", "votesOnThread"],
    UserCreateOrConnectWithoutAccountsInput: ["where", "create"],
    UserUpsertWithoutAccountsInput: ["update", "create"],
    UserUpdateWithoutAccountsInput: ["id", "name", "email", "emailVerified", "updatedAt", "image", "sessions", "premises", "threads", "visions", "timelines", "ReactionOnThreads", "ReactionOnTimelines", "ReactionOnVisions", "votesOnVision", "votesOnTimeline", "votesOnPremise", "votesOnThread"],
    UserCreateWithoutSessionsInput: ["id", "name", "email", "emailVerified", "updatedAt", "image", "accounts", "premises", "threads", "visions", "timelines", "ReactionOnThreads", "ReactionOnTimelines", "ReactionOnVisions", "votesOnVision", "votesOnTimeline", "votesOnPremise", "votesOnThread"],
    UserCreateOrConnectWithoutSessionsInput: ["where", "create"],
    UserUpsertWithoutSessionsInput: ["update", "create"],
    UserUpdateWithoutSessionsInput: ["id", "name", "email", "emailVerified", "updatedAt", "image", "accounts", "premises", "threads", "visions", "timelines", "ReactionOnThreads", "ReactionOnTimelines", "ReactionOnVisions", "votesOnVision", "votesOnTimeline", "votesOnPremise", "votesOnThread"],
    ...
    PremiseCreateWithoutAuthorInput: ["id", "title", "createdAt", "updatedAt", "status", "vision", "premisesOnTimelines", "tagsOnPremises", "threadsOnPremise", "votesOnPremise"],
    PremiseCreateOrConnectWithoutAuthorInput: ["where", "create"],
    PremiseCreateManyAuthorInputEnvelope: ["data", "skipDuplicates"],
    ThreadCreateWithoutAuthorInput: ["id", "title", "activityDate", "description", "createdAt", "reference", "parentThread", "childThreads", "threadsOnPremise", "threadsOnTimeline", "threadsOnVision", "threadsOnMergeRequest", "ReactionOnThreads", "votesOnThread"],
    ...
    TimelineCreateWithoutAuthorInput: ["id", "title", "description", "status", "premisesOnTimelines", "tagsOnTimelines", "threadsOnTimeline", "ReactionOnTimelines", "votesOnTimeline"],
    ...
    VotesOnVisionCreateWithoutUserInput: ["vision", "vote", "createdAt"],
    VotesOnVisionCreateOrConnectWithoutUserInput: ["where", "create"],
    VotesOnVisionCreateManyUserInputEnvelope: ["data", "skipDuplicates"],
    VotesOnTimelineCreateWithoutUserInput: ["timeline", "vote", "createdAt"],
    ...
    VotesOnVisionScalarWhereInput: ["AND", "OR", "NOT", "userId", "visionId", "vote", "createdAt"],
    ...
    VotesOnTimelineScalarWhereInput: ["AND", "OR", "NOT", "userId", "timelineId", "vote", "createdAt"],
    ...
    VotesOnPremiseScalarWhereInput: ["AND", "OR", "NOT", "userId", "premiseId", "vote", "createdAt"],
    ...
    VotesOnThreadScalarWhereInput: ["AND", "OR", "NOT", "userId", "threadId", "vote", "createdAt"],
    UserCreateWithoutPremisesInput: ["id", "name", "email", "emailVerified", "updatedAt", "image", "accounts", "sessions", "threads", "visions", "timelines", "ReactionOnThreads", "ReactionOnTimelines", "ReactionOnVisions", "votesOnVision", "votesOnTimeline", "votesOnPremise", "votesOnThread"],
    ...
    VotesOnPremiseCreateWithoutPremiseInput: ["user", "vote", "createdAt"],
    ...
    UserUpdateWithoutPremisesInput: ["id", "name", "email", "emailVerified", "updatedAt", "image", "accounts", "sessions", "threads", "visions", "timelines", "ReactionOnThreads", "ReactionOnTimelines", "ReactionOnVisions", "votesOnVision", "votesOnTimeline", "votesOnPremise", "votesOnThread"],
    ...
    UserCreateWithoutVisionsInput: ["id", "name", "email", "emailVerified", "updatedAt", "image", "accounts", "sessions", "premises", "threads", "timelines", "ReactionOnThreads", "ReactionOnTimelines", "ReactionOnVisions", "votesOnVision", "votesOnTimeline", "votesOnPremise", "votesOnThread"],
    UserCreateOrConnectWithoutVisionsInput: ["where", "create"],
    PremiseCreateWithoutVisionInput: ["id", "title", "createdAt", "updatedAt", "status", "author", "premisesOnTimelines", "tagsOnPremises", "threadsOnPremise", "votesOnPremise"],
    ...
    VotesOnVisionCreateWithoutVisionInput: ["user", "vote", "createdAt"],
    ...
    UserUpdateWithoutVisionsInput: ["id", "name", "email", "emailVerified", "updatedAt", "image", "accounts", "sessions", "premises", "threads", "timelines", "ReactionOnThreads", "ReactionOnTimelines", "ReactionOnVisions", "votesOnVision", "votesOnTimeline", "votesOnPremise", "votesOnThread"],
    PremiseUpsertWithoutVisionInput: ["update", "create"],
    PremiseUpdateWithoutVisionInput: ["id", "title", "createdAt", "updatedAt", "status", "author", "premisesOnTimelines", "tagsOnPremises", "threadsOnPremise", "votesOnPremise"],
    ...
    UserCreateWithoutTimelinesInput: ["id", "name", "email", "emailVerified", "updatedAt", "image", "accounts", "sessions", "premises", "threads", "visions", "ReactionOnThreads", "ReactionOnTimelines", "ReactionOnVisions", "votesOnVision", "votesOnTimeline", "votesOnPremise", "votesOnThread"],
    ...
    VotesOnTimelineCreateWithoutTimelineInput: ["user", "vote", "createdAt"],
    ...
    UserUpdateWithoutTimelinesInput: ["id", "name", "email", "emailVerified", "updatedAt", "image", "accounts", "sessions", "premises", "threads", "visions", "ReactionOnThreads", "ReactionOnTimelines", "ReactionOnVisions", "votesOnVision", "votesOnTimeline", "votesOnPremise", "votesOnThread"],
    ...
    PremiseCreateWithoutTagsOnPremisesInput: ["id", "title", "createdAt", "updatedAt", "status", "author", "vision", "premisesOnTimelines", "threadsOnPremise", "votesOnPremise"],
    ...
    PremiseUpdateWithoutTagsOnPremisesInput: ["id", "title", "createdAt", "updatedAt", "status", "author", "vision", "premisesOnTimelines", "threadsOnPremise", "votesOnPremise"],
    TagCreateWithoutTagsOnTimelinesInput: ["label", "tagsOnPremises"],
    TagCreateOrConnectWithoutTagsOnTimelinesInput: ["where", "create"],
    TimelineCreateWithoutTagsOnTimelinesInput: ["id", "title", "description", "status", "author", "premisesOnTimelines", "threadsOnTimeline", "ReactionOnTimelines", "votesOnTimeline"],
    ...
    TimelineUpdateWithoutTagsOnTimelinesInput: ["id", "title", "description", "status", "author", "premisesOnTimelines", "threadsOnTimeline", "ReactionOnTimelines", "votesOnTimeline"],
    TimelineCreateWithoutPremisesOnTimelinesInput: ["id", "title", "description", "status", "author", "tagsOnTimelines", "threadsOnTimeline", "ReactionOnTimelines", "votesOnTimeline"],
    TimelineCreateOrConnectWithoutPremisesOnTimelinesInput: ["where", "create"],
    PremiseCreateWithoutPremisesOnTimelinesInput: ["id", "title", "createdAt", "updatedAt", "status", "author", "vision", "tagsOnPremises", "threadsOnPremise", "votesOnPremise"],
    ...
    TimelineUpdateWithoutPremisesOnTimelinesInput: ["id", "title", "description", "status", "author", "tagsOnTimelines", "threadsOnTimeline", "ReactionOnTimelines", "votesOnTimeline"],
    PremiseUpsertWithoutPremisesOnTimelinesInput: ["update", "create"],
    PremiseUpdateWithoutPremisesOnTimelinesInput: ["id", "title", "createdAt", "updatedAt", "status", "author", "vision", "tagsOnPremises", "threadsOnPremise", "votesOnPremise"],
    ...
    UserCreateWithoutThreadsInput: ["id", "name", "email", "emailVerified", "updatedAt", "image", "accounts", "sessions", "premises", "visions", "timelines", "ReactionOnThreads", "ReactionOnTimelines", "ReactionOnVisions", "votesOnVision", "votesOnTimeline", "votesOnPremise", "votesOnThread"],
    UserCreateOrConnectWithoutThreadsInput: ["where", "create"],
    ThreadCreateWithoutChildThreadsInput: ["id", "title", "activityDate", "description", "createdAt", "reference", "author", "parentThread", "threadsOnPremise", "threadsOnTimeline", "threadsOnVision", "threadsOnMergeRequest", "ReactionOnThreads", "votesOnThread"],
    ThreadCreateOrConnectWithoutChildThreadsInput: ["where", "create"],
    ThreadCreateWithoutParentThreadInput: ["id", "title", "activityDate", "description", "createdAt", "reference", "author", "childThreads", "threadsOnPremise", "threadsOnTimeline", "threadsOnVision", "threadsOnMergeRequest", "ReactionOnThreads", "votesOnThread"],
    ...
    VotesOnThreadCreateWithoutThreadInput: ["user", "vote", "createdAt"],
    ...
    UserUpdateWithoutThreadsInput: ["id", "name", "email", "emailVerified", "updatedAt", "image", "accounts", "sessions", "premises", "visions", "timelines", "ReactionOnThreads", "ReactionOnTimelines", "ReactionOnVisions", "votesOnVision", "votesOnTimeline", "votesOnPremise", "votesOnThread"],
    ThreadUpsertWithoutChildThreadsInput: ["update", "create"],
    ThreadUpdateWithoutChildThreadsInput: ["id", "title", "activityDate", "description", "createdAt", "reference", "author", "parentThread", "threadsOnPremise", "threadsOnTimeline", "threadsOnVision", "threadsOnMergeRequest", "ReactionOnThreads", "votesOnThread"],
    ...
    ThreadCreateWithoutThreadsOnMergeRequestInput: ["id", "title", "activityDate", "description", "createdAt", "reference", "author", "parentThread", "childThreads", "threadsOnPremise", "threadsOnTimeline", "threadsOnVision", "ReactionOnThreads", "votesOnThread"],
    ...
    ThreadUpdateWithoutThreadsOnMergeRequestInput: ["id", "title", "activityDate", "description", "createdAt", "reference", "author", "parentThread", "childThreads", "threadsOnPremise", "threadsOnTimeline", "threadsOnVision", "ReactionOnThreads", "votesOnThread"],
    ...
    ThreadCreateWithoutThreadsOnPremiseInput: ["id", "title", "activityDate", "description", "createdAt", "reference", "author", "parentThread", "childThreads", "threadsOnTimeline", "threadsOnVision", "threadsOnMergeRequest", "ReactionOnThreads", "votesOnThread"],
    ThreadCreateOrConnectWithoutThreadsOnPremiseInput: ["where", "create"],
    PremiseCreateWithoutThreadsOnPremiseInput: ["id", "title", "createdAt", "updatedAt", "status", "author", "vision", "premisesOnTimelines", "tagsOnPremises", "votesOnPremise"],
    PremiseCreateOrConnectWithoutThreadsOnPremiseInput: ["where", "create"],
    ThreadUpsertWithoutThreadsOnPremiseInput: ["update", "create"],
    ThreadUpdateWithoutThreadsOnPremiseInput: ["id", "title", "activityDate", "description", "createdAt", "reference", "author", "parentThread", "childThreads", "threadsOnTimeline", "threadsOnVision", "threadsOnMergeRequest", "ReactionOnThreads", "votesOnThread"],
    PremiseUpsertWithoutThreadsOnPremiseInput: ["update", "create"],
    PremiseUpdateWithoutThreadsOnPremiseInput: ["id", "title", "createdAt", "updatedAt", "status", "author", "vision", "premisesOnTimelines", "tagsOnPremises", "votesOnPremise"],
    ThreadCreateWithoutThreadsOnTimelineInput: ["id", "title", "activityDate", "description", "createdAt", "reference", "author", "parentThread", "childThreads", "threadsOnPremise", "threadsOnVision", "threadsOnMergeRequest", "ReactionOnThreads", "votesOnThread"],
    ThreadCreateOrConnectWithoutThreadsOnTimelineInput: ["where", "create"],
    TimelineCreateWithoutThreadsOnTimelineInput: ["id", "title", "description", "status", "author", "premisesOnTimelines", "tagsOnTimelines", "ReactionOnTimelines", "votesOnTimeline"],
    TimelineCreateOrConnectWithoutThreadsOnTimelineInput: ["where", "create"],
    ThreadUpsertWithoutThreadsOnTimelineInput: ["update", "create"],
    ThreadUpdateWithoutThreadsOnTimelineInput: ["id", "title", "activityDate", "description", "createdAt", "reference", "author", "parentThread", "childThreads", "threadsOnPremise", "threadsOnVision", "threadsOnMergeRequest", "ReactionOnThreads", "votesOnThread"],
    TimelineUpsertWithoutThreadsOnTimelineInput: ["update", "create"],
    TimelineUpdateWithoutThreadsOnTimelineInput: ["id", "title", "description", "status", "author", "premisesOnTimelines", "tagsOnTimelines", "ReactionOnTimelines", "votesOnTimeline"],
    UserCreateWithoutReactionOnThreadsInput: ["id", "name", "email", "emailVerified", "updatedAt", "image", "accounts", "sessions", "premises", "threads", "visions", "timelines", "ReactionOnTimelines", "ReactionOnVisions", "votesOnVision", "votesOnTimeline", "votesOnPremise", "votesOnThread"],
    UserCreateOrConnectWithoutReactionOnThreadsInput: ["where", "create"],
    ThreadCreateWithoutReactionOnThreadsInput: ["id", "title", "activityDate", "description", "createdAt", "reference", "author", "parentThread", "childThreads", "threadsOnPremise", "threadsOnTimeline", "threadsOnVision", "threadsOnMergeRequest", "votesOnThread"],
    ThreadCreateOrConnectWithoutReactionOnThreadsInput: ["where", "create"],
    UserUpsertWithoutReactionOnThreadsInput: ["update", "create"],
    UserUpdateWithoutReactionOnThreadsInput: ["id", "name", "email", "emailVerified", "updatedAt", "image", "accounts", "sessions", "premises", "threads", "visions", "timelines", "ReactionOnTimelines", "ReactionOnVisions", "votesOnVision", "votesOnTimeline", "votesOnPremise", "votesOnThread"],
    ThreadUpsertWithoutReactionOnThreadsInput: ["update", "create"],
    ThreadUpdateWithoutReactionOnThreadsInput: ["id", "title", "activityDate", "description", "createdAt", "reference", "author", "parentThread", "childThreads", "threadsOnPremise", "threadsOnTimeline", "threadsOnVision", "threadsOnMergeRequest", "votesOnThread"],
    UserCreateWithoutReactionOnTimelinesInput: ["id", "name", "email", "emailVerified", "updatedAt", "image", "accounts", "sessions", "premises", "threads", "visions", "timelines", "ReactionOnThreads", "ReactionOnVisions", "votesOnVision", "votesOnTimeline", "votesOnPremise", "votesOnThread"],
    UserCreateOrConnectWithoutReactionOnTimelinesInput: ["where", "create"],
    TimelineCreateWithoutReactionOnTimelinesInput: ["id", "title", "description", "status", "author", "premisesOnTimelines", "tagsOnTimelines", "threadsOnTimeline", "votesOnTimeline"],
    ...
    UserUpdateWithoutReactionOnTimelinesInput: ["id", "name", "email", "emailVerified", "updatedAt", "image", "accounts", "sessions", "premises", "threads", "visions", "timelines", "ReactionOnThreads", "ReactionOnVisions", "votesOnVision", "votesOnTimeline", "votesOnPremise", "votesOnThread"],
    TimelineUpsertWithoutReactionOnTimelinesInput: ["update", "create"],
    TimelineUpdateWithoutReactionOnTimelinesInput: ["id", "title", "description", "status", "author", "premisesOnTimelines", "tagsOnTimelines", "threadsOnTimeline", "votesOnTimeline"],
    UserCreateWithoutReactionOnVisionsInput: ["id", "name", "email", "emailVerified", "updatedAt", "image", "accounts", "sessions", "premises", "threads", "visions", "timelines", "ReactionOnThreads", "ReactionOnTimelines", "votesOnVision", "votesOnTimeline", "votesOnPremise", "votesOnThread"],
    ...
    UserUpdateWithoutReactionOnVisionsInput: ["id", "name", "email", "emailVerified", "updatedAt", "image", "accounts", "sessions", "premises", "threads", "visions", "timelines", "ReactionOnThreads", "ReactionOnTimelines", "votesOnVision", "votesOnTimeline", "votesOnPremise", "votesOnThread"],
    ...
    ThreadCreateWithoutThreadsOnVisionInput: ["id", "title", "activityDate", "description", "createdAt", "reference", "author", "parentThread", "childThreads", "threadsOnPremise", "threadsOnTimeline", "threadsOnMergeRequest", "ReactionOnThreads", "votesOnThread"],
    ...
    ThreadUpdateWithoutThreadsOnVisionInput: ["id", "title", "activityDate", "description", "createdAt", "reference", "author", "parentThread", "childThreads", "threadsOnPremise", "threadsOnTimeline", "threadsOnMergeRequest", "ReactionOnThreads", "votesOnThread"],
    ...
    UserCreateWithoutVotesOnVisionInput: ["id", "name", "email", "emailVerified", "updatedAt", "image", "accounts", "sessions", "premises", "threads", "visions", "timelines", "ReactionOnThreads", "ReactionOnTimelines", "ReactionOnVisions", "votesOnTimeline", "votesOnPremise", "votesOnThread"],
    ...
    UserUpdateWithoutVotesOnVisionInput: ["id", "name", "email", "emailVerified", "updatedAt", "image", "accounts", "sessions", "premises", "threads", "visions", "timelines", "ReactionOnThreads", "ReactionOnTimelines", "ReactionOnVisions", "votesOnTimeline", "votesOnPremise", "votesOnThread"],
    ...
    UserCreateWithoutVotesOnTimelineInput: ["id", "name", "email", "emailVerified", "updatedAt", "image", "accounts", "sessions", "premises", "threads", "visions", "timelines", "ReactionOnThreads", "ReactionOnTimelines", "ReactionOnVisions", "votesOnVision", "votesOnPremise", "votesOnThread"],
    UserCreateOrConnectWithoutVotesOnTimelineInput: ["where", "create"],
    TimelineCreateWithoutVotesOnTimelineInput: ["id", "title", "description", "status", "author", "premisesOnTimelines", "tagsOnTimelines", "threadsOnTimeline", "ReactionOnTimelines"],
    TimelineCreateOrConnectWithoutVotesOnTimelineInput: ["where", "create"],
    UserUpsertWithoutVotesOnTimelineInput: ["update", "create"],
    UserUpdateWithoutVotesOnTimelineInput: ["id", "name", "email", "emailVerified", "updatedAt", "image", "accounts", "sessions", "premises", "threads", "visions", "timelines", "ReactionOnThreads", "ReactionOnTimelines", "ReactionOnVisions", "votesOnVision", "votesOnPremise", "votesOnThread"],
    TimelineUpsertWithoutVotesOnTimelineInput: ["update", "create"],
    TimelineUpdateWithoutVotesOnTimelineInput: ["id", "title", "description", "status", "author", "premisesOnTimelines", "tagsOnTimelines", "threadsOnTimeline", "ReactionOnTimelines"],
    UserCreateWithoutVotesOnPremiseInput: ["id", "name", "email", "emailVerified", "updatedAt", "image", "accounts", "sessions", "premises", "threads", "visions", "timelines", "ReactionOnThreads", "ReactionOnTimelines", "ReactionOnVisions", "votesOnVision", "votesOnTimeline", "votesOnThread"],
    UserCreateOrConnectWithoutVotesOnPremiseInput: ["where", "create"],
    PremiseCreateWithoutVotesOnPremiseInput: ["id", "title", "createdAt", "updatedAt", "status", "author", "vision", "premisesOnTimelines", "tagsOnPremises", "threadsOnPremise"],
    PremiseCreateOrConnectWithoutVotesOnPremiseInput: ["where", "create"],
    UserUpsertWithoutVotesOnPremiseInput: ["update", "create"],
    UserUpdateWithoutVotesOnPremiseInput: ["id", "name", "email", "emailVerified", "updatedAt", "image", "accounts", "sessions", "premises", "threads", "visions", "timelines", "ReactionOnThreads", "ReactionOnTimelines", "ReactionOnVisions", "votesOnVision", "votesOnTimeline", "votesOnThread"],
    PremiseUpsertWithoutVotesOnPremiseInput: ["update", "create"],
    PremiseUpdateWithoutVotesOnPremiseInput: ["id", "title", "createdAt", "updatedAt", "status", "author", "vision", "premisesOnTimelines", "tagsOnPremises", "threadsOnPremise"],
    UserCreateWithoutVotesOnThreadInput: ["id", "name", "email", "emailVerified", "updatedAt", "image", "accounts", "sessions", "premises", "threads", "visions", "timelines", "ReactionOnThreads", "ReactionOnTimelines", "ReactionOnVisions", "votesOnVision", "votesOnTimeline", "votesOnPremise"],
    UserCreateOrConnectWithoutVotesOnThreadInput: ["where", "create"],
    ThreadCreateWithoutVotesOnThreadInput: ["id", "title", "activityDate", "description", "createdAt", "reference", "author", "parentThread", "childThreads", "threadsOnPremise", "threadsOnTimeline", "threadsOnVision", "threadsOnMergeRequest", "ReactionOnThreads"],
    ThreadCreateOrConnectWithoutVotesOnThreadInput: ["where", "create"],
    UserUpsertWithoutVotesOnThreadInput: ["update", "create"],
    UserUpdateWithoutVotesOnThreadInput: ["id", "name", "email", "emailVerified", "updatedAt", "image", "accounts", "sessions", "premises", "threads", "visions", "timelines", "ReactionOnThreads", "ReactionOnTimelines", "ReactionOnVisions", "votesOnVision", "votesOnTimeline", "votesOnPremise"],
    ThreadUpsertWithoutVotesOnThreadInput: ["update", "create"],
    ThreadUpdateWithoutVotesOnThreadInput: ["id", "title", "activityDate", "description", "createdAt", "reference", "author", "parentThread", "childThreads", "threadsOnPremise", "threadsOnTimeline", "threadsOnVision", "threadsOnMergeRequest", "ReactionOnThreads"],
    ...
    VotesOnVisionCreateManyUserInput: ["visionId", "vote", "createdAt"],
    VotesOnTimelineCreateManyUserInput: ["timelineId", "vote", "createdAt"],
    VotesOnPremiseCreateManyUserInput: ["premiseId", "vote", "createdAt"],
    VotesOnThreadCreateManyUserInput: ["threadId", "vote", "createdAt"],
    ...
    PremiseUpdateWithoutAuthorInput: ["id", "title", "createdAt", "updatedAt", "status", "vision", "premisesOnTimelines", "tagsOnPremises", "threadsOnPremise", "votesOnPremise"],
    ThreadUpdateWithoutAuthorInput: ["id", "title", "activityDate", "description", "createdAt", "reference", "parentThread", "childThreads", "threadsOnPremise", "threadsOnTimeline", "threadsOnVision", "threadsOnMergeRequest", "ReactionOnThreads", "votesOnThread"],
    ...
    TimelineUpdateWithoutAuthorInput: ["id", "title", "description", "status", "premisesOnTimelines", "tagsOnTimelines", "threadsOnTimeline", "ReactionOnTimelines", "votesOnTimeline"],
    ...
    VotesOnVisionUpdateWithoutUserInput: ["vision", "vote", "createdAt"],
    VotesOnTimelineUpdateWithoutUserInput: ["timeline", "vote", "createdAt"],
    VotesOnPremiseUpdateWithoutUserInput: ["premise", "vote", "createdAt"],
    VotesOnThreadUpdateWithoutUserInput: ["thread", "vote", "createdAt"],
    ...
    VotesOnPremiseCreateManyPremiseInput: ["userId", "vote", "createdAt"],
    ...
    VotesOnPremiseUpdateWithoutPremiseInput: ["user", "vote", "createdAt"],
    ...
    VotesOnVisionCreateManyVisionInput: ["userId", "vote", "createdAt"],
    ...
    VotesOnVisionUpdateWithoutVisionInput: ["user", "vote", "createdAt"],
    ...
    VotesOnTimelineCreateManyTimelineInput: ["userId", "vote", "createdAt"],
    ...
    VotesOnTimelineUpdateWithoutTimelineInput: ["user", "vote", "createdAt"],
    ...
    VotesOnThreadCreateManyThreadInput: ["userId", "vote", "createdAt"],
    ThreadUpdateWithoutParentThreadInput: ["id", "title", "activityDate", "description", "createdAt", "reference", "author", "childThreads", "threadsOnPremise", "threadsOnTimeline", "threadsOnVision", "threadsOnMergeRequest", "ReactionOnThreads", "votesOnThread"],
    ReactionOnThreadsUpdateWithoutThreadInput: ["user", "reaction", "createdAt"],
    VotesOnThreadUpdateWithoutThreadInput: ["user", "vote", "createdAt"]
};
