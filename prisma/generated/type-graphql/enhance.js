...
const relationResolversInfo = {
    ...
    Vision: ["reference", "author", "premise", "prevVision", "nextVisions", "threadsOnVision", "mergeRequest", "reactionOnVisions", "votesOnVision"],
...
const outputsInfo = {
    ...
    VisionCount: ["nextVisions", "threadsOnVision", "reactionOnVisions", "votesOnVision"],
...
const inputsInfo = {
    ...
    VisionWhereInput: ["AND", "OR", "NOT", "id", "title", "activityDate", "description", "updatedAt", "createdAt", "reference", "referenceId", "author", "authorId", "premise", "thumbnail", "premiseId", "draftMode", "prevVisionId", "prevVision", "nextVisions", "threadsOnVision", "mergeRequest", "reactionOnVisions", "votesOnVision"],
    VisionOrderByWithRelationInput: ["id", "title", "activityDate", "description", "updatedAt", "createdAt", "reference", "referenceId", "author", "authorId", "premise", "thumbnail", "premiseId", "draftMode", "prevVisionId", "prevVision", "nextVisions", "threadsOnVision", "mergeRequest", "reactionOnVisions", "votesOnVision"],
    ...
    VisionCreateInput: ["id", "title", "activityDate", "description", "updatedAt", "createdAt", "reference", "author", "premise", "thumbnail", "draftMode", "prevVision", "nextVisions", "threadsOnVision", "mergeRequest", "reactionOnVisions", "votesOnVision"],
    VisionUpdateInput: ["id", "title", "activityDate", "description", "updatedAt", "createdAt", "reference", "author", "premise", "thumbnail", "draftMode", "prevVision", "nextVisions", "threadsOnVision", "mergeRequest", "reactionOnVisions", "votesOnVision"],
    ...
    VisionCreateWithoutAuthorInput: ["id", "title", "activityDate", "description", "updatedAt", "createdAt", "reference", "premise", "thumbnail", "draftMode", "prevVision", "nextVisions", "threadsOnVision", "mergeRequest", "reactionOnVisions", "votesOnVision"],
    ...
    VisionCreateWithoutPremiseInput: ["id", "title", "activityDate", "description", "updatedAt", "createdAt", "reference", "author", "thumbnail", "draftMode", "prevVision", "nextVisions", "threadsOnVision", "mergeRequest", "reactionOnVisions", "votesOnVision"],
    ...
    VisionCreateWithoutNextVisionsInput: ["id", "title", "activityDate", "description", "updatedAt", "createdAt", "reference", "author", "premise", "thumbnail", "draftMode", "prevVision", "threadsOnVision", "mergeRequest", "reactionOnVisions", "votesOnVision"],
    VisionCreateOrConnectWithoutNextVisionsInput: ["where", "create"],
    VisionCreateWithoutPrevVisionInput: ["id", "title", "activityDate", "description", "updatedAt", "createdAt", "reference", "author", "premise", "thumbnail", "draftMode", "nextVisions", "threadsOnVision", "mergeRequest", "reactionOnVisions", "votesOnVision"],
    ...
    VisionUpdateWithoutNextVisionsInput: ["id", "title", "activityDate", "description", "updatedAt", "createdAt", "reference", "author", "premise", "thumbnail", "draftMode", "prevVision", "threadsOnVision", "mergeRequest", "reactionOnVisions", "votesOnVision"],
    ...
    VisionCreateWithoutReferenceInput: ["id", "title", "activityDate", "description", "updatedAt", "createdAt", "author", "premise", "thumbnail", "draftMode", "prevVision", "nextVisions", "threadsOnVision", "mergeRequest", "reactionOnVisions", "votesOnVision"],
    ...
    VisionCreateWithoutMergeRequestInput: ["id", "title", "activityDate", "description", "updatedAt", "createdAt", "reference", "author", "premise", "thumbnail", "draftMode", "prevVision", "nextVisions", "threadsOnVision", "reactionOnVisions", "votesOnVision"],
    ...
    VisionUpdateWithoutMergeRequestInput: ["id", "title", "activityDate", "description", "updatedAt", "createdAt", "reference", "author", "premise", "thumbnail", "draftMode", "prevVision", "nextVisions", "threadsOnVision", "reactionOnVisions", "votesOnVision"],
    ...
    VisionCreateWithoutReactionOnVisionsInput: ["id", "title", "activityDate", "description", "updatedAt", "createdAt", "reference", "author", "premise", "thumbnail", "draftMode", "prevVision", "nextVisions", "threadsOnVision", "mergeRequest", "votesOnVision"],
    ...
    VisionUpdateWithoutReactionOnVisionsInput: ["id", "title", "activityDate", "description", "updatedAt", "createdAt", "reference", "author", "premise", "thumbnail", "draftMode", "prevVision", "nextVisions", "threadsOnVision", "mergeRequest", "votesOnVision"],
    ...
    VisionCreateWithoutThreadsOnVisionInput: ["id", "title", "activityDate", "description", "updatedAt", "createdAt", "reference", "author", "premise", "thumbnail", "draftMode", "prevVision", "nextVisions", "mergeRequest", "reactionOnVisions", "votesOnVision"],
    ...
    VisionUpdateWithoutThreadsOnVisionInput: ["id", "title", "activityDate", "description", "updatedAt", "createdAt", "reference", "author", "premise", "thumbnail", "draftMode", "prevVision", "nextVisions", "mergeRequest", "reactionOnVisions", "votesOnVision"],
    ...
    VisionCreateWithoutVotesOnVisionInput: ["id", "title", "activityDate", "description", "updatedAt", "createdAt", "reference", "author", "premise", "thumbnail", "draftMode", "prevVision", "nextVisions", "threadsOnVision", "mergeRequest", "reactionOnVisions"],
    ...
    VisionUpdateWithoutVotesOnVisionInput: ["id", "title", "activityDate", "description", "updatedAt", "createdAt", "reference", "author", "premise", "thumbnail", "draftMode", "prevVision", "nextVisions", "threadsOnVision", "mergeRequest", "reactionOnVisions"],
    ...
    VisionUpdateWithoutAuthorInput: ["id", "title", "activityDate", "description", "updatedAt", "createdAt", "reference", "premise", "thumbnail", "draftMode", "prevVision", "nextVisions", "threadsOnVision", "mergeRequest", "reactionOnVisions", "votesOnVision"],
    ...
    VisionUpdateWithoutPremiseInput: ["id", "title", "activityDate", "description", "updatedAt", "createdAt", "reference", "author", "thumbnail", "draftMode", "prevVision", "nextVisions", "threadsOnVision", "mergeRequest", "reactionOnVisions", "votesOnVision"],
    ...
    VisionUpdateWithoutPrevVisionInput: ["id", "title", "activityDate", "description", "updatedAt", "createdAt", "reference", "author", "premise", "thumbnail", "draftMode", "nextVisions", "threadsOnVision", "mergeRequest", "reactionOnVisions", "votesOnVision"],
    ...
    VisionUpdateWithoutReferenceInput: ["id", "title", "activityDate", "description", "updatedAt", "createdAt", "author", "premise", "thumbnail", "draftMode", "prevVision", "nextVisions", "threadsOnVision", "mergeRequest", "reactionOnVisions", "votesOnVision"],
