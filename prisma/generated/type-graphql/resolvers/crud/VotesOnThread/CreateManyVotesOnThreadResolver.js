...
exports.CreateManyVotesOnThreadResolver = void 0;
...
let CreateManyVotesOnThreadResolver = class CreateManyVotesOnThreadResolver {
...
], CreateManyVotesOnThreadResolver.prototype, "createManyVotesOnThread", null);
CreateManyVotesOnThreadResolver = tslib_1.__decorate([
    TypeGraphQL.Resolver(_of => VotesOnThread_1.VotesOnThread)
], CreateManyVotesOnThreadResolver);
exports.CreateManyVotesOnThreadResolver = CreateManyVotesOnThreadResolver;
