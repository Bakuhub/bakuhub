...
exports.CreateThreadResolver = void 0;
...
let CreateThreadResolver = class CreateThreadResolver {
...
], CreateThreadResolver.prototype, "createThread", null);
CreateThreadResolver = tslib_1.__decorate([
    TypeGraphQL.Resolver(_of => Thread_1.Thread)
], CreateThreadResolver);
exports.CreateThreadResolver = CreateThreadResolver;
