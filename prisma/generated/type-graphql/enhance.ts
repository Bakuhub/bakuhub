...
const crudResolversMap = {
  ...
  ReactionOnThread: crudResolvers.ReactionOnThreadCrudResolver,
  ReactionOnTimeline: crudResolvers.ReactionOnTimelineCrudResolver,
  ReactionOnVision: crudResolvers.ReactionOnVisionCrudResolver,
...
const actionResolversMap = {
  ...
  ReactionOnThread: {
    reactionOnThread: actionResolvers.FindUniqueReactionOnThreadResolver,
    findFirstReactionOnThread: actionResolvers.FindFirstReactionOnThreadResolver,
    reactionOnThreads: actionResolvers.FindManyReactionOnThreadResolver,
    createReactionOnThread: actionResolvers.CreateReactionOnThreadResolver,
    createManyReactionOnThread: actionResolvers.CreateManyReactionOnThreadResolver,
    deleteReactionOnThread: actionResolvers.DeleteReactionOnThreadResolver,
    updateReactionOnThread: actionResolvers.UpdateReactionOnThreadResolver,
    deleteManyReactionOnThread: actionResolvers.DeleteManyReactionOnThreadResolver,
    updateManyReactionOnThread: actionResolvers.UpdateManyReactionOnThreadResolver,
    upsertReactionOnThread: actionResolvers.UpsertReactionOnThreadResolver,
    aggregateReactionOnThread: actionResolvers.AggregateReactionOnThreadResolver,
    groupByReactionOnThread: actionResolvers.GroupByReactionOnThreadResolver
  },
  ReactionOnTimeline: {
    reactionOnTimeline: actionResolvers.FindUniqueReactionOnTimelineResolver,
    findFirstReactionOnTimeline: actionResolvers.FindFirstReactionOnTimelineResolver,
    reactionOnTimelines: actionResolvers.FindManyReactionOnTimelineResolver,
    createReactionOnTimeline: actionResolvers.CreateReactionOnTimelineResolver,
    createManyReactionOnTimeline: actionResolvers.CreateManyReactionOnTimelineResolver,
    deleteReactionOnTimeline: actionResolvers.DeleteReactionOnTimelineResolver,
    updateReactionOnTimeline: actionResolvers.UpdateReactionOnTimelineResolver,
    deleteManyReactionOnTimeline: actionResolvers.DeleteManyReactionOnTimelineResolver,
    updateManyReactionOnTimeline: actionResolvers.UpdateManyReactionOnTimelineResolver,
    upsertReactionOnTimeline: actionResolvers.UpsertReactionOnTimelineResolver,
    aggregateReactionOnTimeline: actionResolvers.AggregateReactionOnTimelineResolver,
    groupByReactionOnTimeline: actionResolvers.GroupByReactionOnTimelineResolver
  },
  ReactionOnVision: {
    reactionOnVision: actionResolvers.FindUniqueReactionOnVisionResolver,
    findFirstReactionOnVision: actionResolvers.FindFirstReactionOnVisionResolver,
    reactionOnVisions: actionResolvers.FindManyReactionOnVisionResolver,
    createReactionOnVision: actionResolvers.CreateReactionOnVisionResolver,
    createManyReactionOnVision: actionResolvers.CreateManyReactionOnVisionResolver,
    deleteReactionOnVision: actionResolvers.DeleteReactionOnVisionResolver,
    updateReactionOnVision: actionResolvers.UpdateReactionOnVisionResolver,
    deleteManyReactionOnVision: actionResolvers.DeleteManyReactionOnVisionResolver,
    updateManyReactionOnVision: actionResolvers.UpdateManyReactionOnVisionResolver,
    upsertReactionOnVision: actionResolvers.UpsertReactionOnVisionResolver,
    aggregateReactionOnVision: actionResolvers.AggregateReactionOnVisionResolver,
    groupByReactionOnVision: actionResolvers.GroupByReactionOnVisionResolver
  },
  ThreadsOnVision: {
...
const crudResolversInfo = {
  ...
  ReactionOnThread: ["reactionOnThread", "findFirstReactionOnThread", "reactionOnThreads", "createReactionOnThread", "createManyReactionOnThread", "deleteReactionOnThread", "updateReactionOnThread", "deleteManyReactionOnThread", "updateManyReactionOnThread", "upsertReactionOnThread", "aggregateReactionOnThread", "groupByReactionOnThread"],
  ReactionOnTimeline: ["reactionOnTimeline", "findFirstReactionOnTimeline", "reactionOnTimelines", "createReactionOnTimeline", "createManyReactionOnTimeline", "deleteReactionOnTimeline", "updateReactionOnTimeline", "deleteManyReactionOnTimeline", "updateManyReactionOnTimeline", "upsertReactionOnTimeline", "aggregateReactionOnTimeline", "groupByReactionOnTimeline"],
  ReactionOnVision: ["reactionOnVision", "findFirstReactionOnVision", "reactionOnVisions", "createReactionOnVision", "createManyReactionOnVision", "deleteReactionOnVision", "updateReactionOnVision", "deleteManyReactionOnVision", "updateManyReactionOnVision", "upsertReactionOnVision", "aggregateReactionOnVision", "groupByReactionOnVision"],
...
const argsInfo = {
  ...
  FindUniqueReactionOnThreadArgs: ["where"],
  FindFirstReactionOnThreadArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
  FindManyReactionOnThreadArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
  CreateReactionOnThreadArgs: ["data"],
  CreateManyReactionOnThreadArgs: ["data", "skipDuplicates"],
  DeleteReactionOnThreadArgs: ["where"],
  UpdateReactionOnThreadArgs: ["data", "where"],
  DeleteManyReactionOnThreadArgs: ["where"],
  UpdateManyReactionOnThreadArgs: ["data", "where"],
  UpsertReactionOnThreadArgs: ["where", "create", "update"],
  AggregateReactionOnThreadArgs: ["where", "orderBy", "cursor", "take", "skip"],
  GroupByReactionOnThreadArgs: ["where", "orderBy", "by", "having", "take", "skip"],
  FindUniqueReactionOnTimelineArgs: ["where"],
  FindFirstReactionOnTimelineArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
  FindManyReactionOnTimelineArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
  CreateReactionOnTimelineArgs: ["data"],
  CreateManyReactionOnTimelineArgs: ["data", "skipDuplicates"],
  DeleteReactionOnTimelineArgs: ["where"],
  UpdateReactionOnTimelineArgs: ["data", "where"],
  DeleteManyReactionOnTimelineArgs: ["where"],
  UpdateManyReactionOnTimelineArgs: ["data", "where"],
  UpsertReactionOnTimelineArgs: ["where", "create", "update"],
  AggregateReactionOnTimelineArgs: ["where", "orderBy", "cursor", "take", "skip"],
  GroupByReactionOnTimelineArgs: ["where", "orderBy", "by", "having", "take", "skip"],
  FindUniqueReactionOnVisionArgs: ["where"],
  FindFirstReactionOnVisionArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
  FindManyReactionOnVisionArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
  CreateReactionOnVisionArgs: ["data"],
  CreateManyReactionOnVisionArgs: ["data", "skipDuplicates"],
  DeleteReactionOnVisionArgs: ["where"],
  UpdateReactionOnVisionArgs: ["data", "where"],
  DeleteManyReactionOnVisionArgs: ["where"],
  UpdateManyReactionOnVisionArgs: ["data", "where"],
  UpsertReactionOnVisionArgs: ["where", "create", "update"],
  AggregateReactionOnVisionArgs: ["where", "orderBy", "cursor", "take", "skip"],
  GroupByReactionOnVisionArgs: ["where", "orderBy", "by", "having", "take", "skip"],
...
const relationResolversMap = {
  ...
  ReactionOnThread: relationResolvers.ReactionOnThreadRelationsResolver,
  ReactionOnTimeline: relationResolvers.ReactionOnTimelineRelationsResolver,
  ReactionOnVision: relationResolvers.ReactionOnVisionRelationsResolver,
  ThreadsOnVision: relationResolvers.ThreadsOnVisionRelationsResolver
};
const relationResolversInfo = {
  Account: ["user"],
  Session: ["user"],
  User: ["accounts", "sessions", "premises", "threads", "visions", "timelines", "ReactionOnThread", "ReactionOnTimeline", "ReactionOnVision"],
  Premise: ["author", "vision", "premisesOnTimelines", "tagsOnPremises", "threadsOnPremise"],
  Vision: ["reference", "author", "premise", "prevVision", "nextVisions", "threadsOnVision", "mergeRequest", "ReactionOnVision"],
  Reference: ["snapshots", "Vision"],
  MergeRequest: ["vision"],
  Timeline: ["author", "premisesOnTimelines", "tagsOnTimelines", "threadsOnTimeline", "ReactionOnTimeline"],
  ...
  Snapshot: ["references"],
  Thread: ["author", "parentThread", "childThreads", "threadsOnPremise", "threadsOnTimeline", "threadsOnVision", "ReactionOnThread"],
  ThreadsOnPremise: ["thread", "premise"],
  ThreadsOnTimeline: ["thread", "timeline"],
  ReactionOnThread: ["user", "thread"],
  ReactionOnTimeline: ["user", "timeline"],
  ReactionOnVision: ["user", "vision"],
...
const modelsInfo = {
  ...
  ReactionOnThread: ["id", "userId", "threadId", "reaction", "createdAt"],
  ReactionOnTimeline: ["id", "userId", "timelineId", "reaction", "createdAt"],
  ReactionOnVision: ["id", "userId", "visionId", "reaction", "createdAt"],
...
const outputsInfo = {
  ...
  AggregateReactionOnThread: ["_count", "_min", "_max"],
  ReactionOnThreadGroupBy: ["id", "userId", "threadId", "reaction", "createdAt", "_count", "_min", "_max"],
  AggregateReactionOnTimeline: ["_count", "_min", "_max"],
  ReactionOnTimelineGroupBy: ["id", "userId", "timelineId", "reaction", "createdAt", "_count", "_min", "_max"],
  AggregateReactionOnVision: ["_count", "_min", "_max"],
  ReactionOnVisionGroupBy: ["id", "userId", "visionId", "reaction", "createdAt", "_count", "_min", "_max"],
  ...
  UserCount: ["accounts", "sessions", "premises", "threads", "visions", "timelines", "ReactionOnThread", "ReactionOnTimeline", "ReactionOnVision"],
  ...
  VisionCount: ["nextVisions", "threadsOnVision", "ReactionOnVision"],
  ...
  TimelineCount: ["premisesOnTimelines", "tagsOnTimelines", "threadsOnTimeline", "ReactionOnTimeline"],
  ...
  ThreadCount: ["childThreads", "ReactionOnThread"],
  ...
  ReactionOnThreadCountAggregate: ["id", "userId", "threadId", "reaction", "createdAt", "_all"],
  ReactionOnThreadMinAggregate: ["id", "userId", "threadId", "reaction", "createdAt"],
  ReactionOnThreadMaxAggregate: ["id", "userId", "threadId", "reaction", "createdAt"],
  ReactionOnTimelineCountAggregate: ["id", "userId", "timelineId", "reaction", "createdAt", "_all"],
  ReactionOnTimelineMinAggregate: ["id", "userId", "timelineId", "reaction", "createdAt"],
  ReactionOnTimelineMaxAggregate: ["id", "userId", "timelineId", "reaction", "createdAt"],
  ReactionOnVisionCountAggregate: ["id", "userId", "visionId", "reaction", "createdAt", "_all"],
  ReactionOnVisionMinAggregate: ["id", "userId", "visionId", "reaction", "createdAt"],
  ReactionOnVisionMaxAggregate: ["id", "userId", "visionId", "reaction", "createdAt"],
...
const inputsInfo = {
  ...
  UserWhereInput: ["AND", "OR", "NOT", "id", "name", "email", "emailVerified", "updatedAt", "image", "accounts", "sessions", "premises", "threads", "visions", "timelines", "ReactionOnThread", "ReactionOnTimeline", "ReactionOnVision"],
  UserOrderByWithRelationInput: ["id", "name", "email", "emailVerified", "updatedAt", "image", "accounts", "sessions", "premises", "threads", "visions", "timelines", "ReactionOnThread", "ReactionOnTimeline", "ReactionOnVision"],
  ...
  VisionWhereInput: ["AND", "OR", "NOT", "id", "title", "activityDate", "description", "updatedAt", "createdAt", "reference", "referenceId", "author", "authorId", "premise", "thumbnail", "premiseId", "draftMode", "prevVisionId", "prevVision", "nextVisions", "threadsOnVision", "mergeRequest", "ReactionOnVision"],
  VisionOrderByWithRelationInput: ["id", "title", "activityDate", "description", "updatedAt", "createdAt", "reference", "referenceId", "author", "authorId", "premise", "thumbnail", "premiseId", "draftMode", "prevVisionId", "prevVision", "nextVisions", "threadsOnVision", "mergeRequest", "ReactionOnVision"],
  ...
  TimelineWhereInput: ["AND", "OR", "NOT", "id", "title", "description", "status", "author", "authorId", "premisesOnTimelines", "tagsOnTimelines", "threadsOnTimeline", "ReactionOnTimeline"],
  TimelineOrderByWithRelationInput: ["id", "title", "description", "status", "author", "authorId", "premisesOnTimelines", "tagsOnTimelines", "threadsOnTimeline", "ReactionOnTimeline"],
  ...
  ThreadWhereInput: ["AND", "OR", "NOT", "id", "title", "activityDate", "description", "createdAt", "reference", "author", "authorId", "parentThreadId", "parentThread", "childThreads", "threadsOnPremise", "threadsOnTimeline", "threadsOnVision", "ReactionOnThread"],
  ThreadOrderByWithRelationInput: ["id", "title", "activityDate", "description", "createdAt", "reference", "author", "authorId", "parentThreadId", "parentThread", "childThreads", "threadsOnPremise", "threadsOnTimeline", "threadsOnVision", "ReactionOnThread"],
  ...
  ReactionOnThreadWhereInput: ["AND", "OR", "NOT", "id", "user", "userId", "thread", "threadId", "reaction", "createdAt"],
  ReactionOnThreadOrderByWithRelationInput: ["id", "user", "userId", "thread", "threadId", "reaction", "createdAt"],
  ReactionOnThreadWhereUniqueInput: ["id"],
  ReactionOnThreadOrderByWithAggregationInput: ["id", "userId", "threadId", "reaction", "createdAt", "_count", "_max", "_min"],
  ReactionOnThreadScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "userId", "threadId", "reaction", "createdAt"],
  ReactionOnTimelineWhereInput: ["AND", "OR", "NOT", "id", "user", "userId", "timeline", "timelineId", "reaction", "createdAt"],
  ReactionOnTimelineOrderByWithRelationInput: ["id", "user", "userId", "timeline", "timelineId", "reaction", "createdAt"],
  ReactionOnTimelineWhereUniqueInput: ["id"],
  ReactionOnTimelineOrderByWithAggregationInput: ["id", "userId", "timelineId", "reaction", "createdAt", "_count", "_max", "_min"],
  ReactionOnTimelineScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "userId", "timelineId", "reaction", "createdAt"],
  ReactionOnVisionWhereInput: ["AND", "OR", "NOT", "id", "user", "userId", "vision", "visionId", "reaction", "createdAt"],
  ReactionOnVisionOrderByWithRelationInput: ["id", "user", "userId", "vision", "visionId", "reaction", "createdAt"],
  ReactionOnVisionWhereUniqueInput: ["id"],
  ReactionOnVisionOrderByWithAggregationInput: ["id", "userId", "visionId", "reaction", "createdAt", "_count", "_max", "_min"],
  ReactionOnVisionScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "userId", "visionId", "reaction", "createdAt"],
  ...
  UserCreateInput: ["id", "name", "email", "emailVerified", "updatedAt", "image", "accounts", "sessions", "premises", "threads", "visions", "timelines", "ReactionOnThread", "ReactionOnTimeline", "ReactionOnVision"],
  UserUpdateInput: ["id", "name", "email", "emailVerified", "updatedAt", "image", "accounts", "sessions", "premises", "threads", "visions", "timelines", "ReactionOnThread", "ReactionOnTimeline", "ReactionOnVision"],
  ...
  VisionCreateInput: ["id", "title", "activityDate", "description", "updatedAt", "createdAt", "reference", "author", "premise", "thumbnail", "draftMode", "prevVision", "nextVisions", "threadsOnVision", "mergeRequest", "ReactionOnVision"],
  VisionUpdateInput: ["id", "title", "activityDate", "description", "updatedAt", "createdAt", "reference", "author", "premise", "thumbnail", "draftMode", "prevVision", "nextVisions", "threadsOnVision", "mergeRequest", "ReactionOnVision"],
  ...
  TimelineCreateInput: ["id", "title", "description", "status", "author", "premisesOnTimelines", "tagsOnTimelines", "threadsOnTimeline", "ReactionOnTimeline"],
  TimelineUpdateInput: ["id", "title", "description", "status", "author", "premisesOnTimelines", "tagsOnTimelines", "threadsOnTimeline", "ReactionOnTimeline"],
  ...
  ThreadCreateInput: ["id", "title", "activityDate", "description", "createdAt", "reference", "author", "parentThread", "childThreads", "threadsOnPremise", "threadsOnTimeline", "threadsOnVision", "ReactionOnThread"],
  ThreadUpdateInput: ["id", "title", "activityDate", "description", "createdAt", "reference", "author", "parentThread", "childThreads", "threadsOnPremise", "threadsOnTimeline", "threadsOnVision", "ReactionOnThread"],
  ...
  ReactionOnThreadCreateInput: ["id", "user", "thread", "reaction", "createdAt"],
  ReactionOnThreadUpdateInput: ["id", "user", "thread", "reaction", "createdAt"],
  ReactionOnThreadCreateManyInput: ["id", "userId", "threadId", "reaction", "createdAt"],
  ReactionOnThreadUpdateManyMutationInput: ["id", "reaction", "createdAt"],
  ReactionOnTimelineCreateInput: ["id", "user", "timeline", "reaction", "createdAt"],
  ReactionOnTimelineUpdateInput: ["id", "user", "timeline", "reaction", "createdAt"],
  ReactionOnTimelineCreateManyInput: ["id", "userId", "timelineId", "reaction", "createdAt"],
  ReactionOnTimelineUpdateManyMutationInput: ["id", "reaction", "createdAt"],
  ReactionOnVisionCreateInput: ["id", "user", "vision", "reaction", "createdAt"],
  ReactionOnVisionUpdateInput: ["id", "user", "vision", "reaction", "createdAt"],
  ReactionOnVisionCreateManyInput: ["id", "userId", "visionId", "reaction", "createdAt"],
  ReactionOnVisionUpdateManyMutationInput: ["id", "reaction", "createdAt"],
  ...
  ReactionOnThreadListRelationFilter: ["every", "some", "none"],
  ReactionOnTimelineListRelationFilter: ["every", "some", "none"],
  ReactionOnVisionListRelationFilter: ["every", "some", "none"],
  ...
  ReactionOnThreadOrderByRelationAggregateInput: ["_count"],
  ReactionOnTimelineOrderByRelationAggregateInput: ["_count"],
  ReactionOnVisionOrderByRelationAggregateInput: ["_count"],
  ...
  ReactionOnThreadCountOrderByAggregateInput: ["id", "userId", "threadId", "reaction", "createdAt"],
  ReactionOnThreadMaxOrderByAggregateInput: ["id", "userId", "threadId", "reaction", "createdAt"],
  ReactionOnThreadMinOrderByAggregateInput: ["id", "userId", "threadId", "reaction", "createdAt"],
  EnumReactionWithAggregatesFilter: ["equals", "in", "notIn", "not", "_count", "_min", "_max"],
  ReactionOnTimelineCountOrderByAggregateInput: ["id", "userId", "timelineId", "reaction", "createdAt"],
  ReactionOnTimelineMaxOrderByAggregateInput: ["id", "userId", "timelineId", "reaction", "createdAt"],
  ReactionOnTimelineMinOrderByAggregateInput: ["id", "userId", "timelineId", "reaction", "createdAt"],
  ReactionOnVisionCountOrderByAggregateInput: ["id", "userId", "visionId", "reaction", "createdAt"],
  ReactionOnVisionMaxOrderByAggregateInput: ["id", "userId", "visionId", "reaction", "createdAt"],
  ReactionOnVisionMinOrderByAggregateInput: ["id", "userId", "visionId", "reaction", "createdAt"],
  ...
  ReactionOnThreadCreateNestedManyWithoutUserInput: ["create", "connectOrCreate", "createMany", "connect"],
  ReactionOnTimelineCreateNestedManyWithoutUserInput: ["create", "connectOrCreate", "createMany", "connect"],
  ReactionOnVisionCreateNestedManyWithoutUserInput: ["create", "connectOrCreate", "createMany", "connect"],
  ...
  ReactionOnThreadUpdateManyWithoutUserInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  ReactionOnTimelineUpdateManyWithoutUserInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  ReactionOnVisionUpdateManyWithoutUserInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  ...
  ReactionOnVisionCreateNestedManyWithoutVisionInput: ["create", "connectOrCreate", "createMany", "connect"],
  ...
  ReactionOnVisionUpdateManyWithoutVisionInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  ...
  ReactionOnTimelineCreateNestedManyWithoutTimelineInput: ["create", "connectOrCreate", "createMany", "connect"],
  ...
  ReactionOnTimelineUpdateManyWithoutTimelineInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  ...
  ReactionOnThreadCreateNestedManyWithoutThreadInput: ["create", "connectOrCreate", "createMany", "connect"],
  ...
  ReactionOnThreadUpdateManyWithoutThreadInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  ...
  UserCreateNestedOneWithoutReactionOnThreadInput: ["create", "connectOrCreate", "connect"],
  ThreadCreateNestedOneWithoutReactionOnThreadInput: ["create", "connectOrCreate", "connect"],
  UserUpdateOneRequiredWithoutReactionOnThreadInput: ["create", "connectOrCreate", "upsert", "connect", "update"],
  ThreadUpdateOneRequiredWithoutReactionOnThreadInput: ["create", "connectOrCreate", "upsert", "connect", "update"],
  EnumReactionFieldUpdateOperationsInput: ["set"],
  UserCreateNestedOneWithoutReactionOnTimelineInput: ["create", "connectOrCreate", "connect"],
  TimelineCreateNestedOneWithoutReactionOnTimelineInput: ["create", "connectOrCreate", "connect"],
  UserUpdateOneRequiredWithoutReactionOnTimelineInput: ["create", "connectOrCreate", "upsert", "connect", "update"],
  TimelineUpdateOneRequiredWithoutReactionOnTimelineInput: ["create", "connectOrCreate", "upsert", "connect", "update"],
  UserCreateNestedOneWithoutReactionOnVisionInput: ["create", "connectOrCreate", "connect"],
  VisionCreateNestedOneWithoutReactionOnVisionInput: ["create", "connectOrCreate", "connect"],
  UserUpdateOneRequiredWithoutReactionOnVisionInput: ["create", "connectOrCreate", "upsert", "connect", "update"],
  VisionUpdateOneRequiredWithoutReactionOnVisionInput: ["create", "connectOrCreate", "upsert", "connect", "update"],
  ...
  UserCreateWithoutAccountsInput: ["id", "name", "email", "emailVerified", "updatedAt", "image", "sessions", "premises", "threads", "visions", "timelines", "ReactionOnThread", "ReactionOnTimeline", "ReactionOnVision"],
  UserCreateOrConnectWithoutAccountsInput: ["where", "create"],
  UserUpsertWithoutAccountsInput: ["update", "create"],
  UserUpdateWithoutAccountsInput: ["id", "name", "email", "emailVerified", "updatedAt", "image", "sessions", "premises", "threads", "visions", "timelines", "ReactionOnThread", "ReactionOnTimeline", "ReactionOnVision"],
  UserCreateWithoutSessionsInput: ["id", "name", "email", "emailVerified", "updatedAt", "image", "accounts", "premises", "threads", "visions", "timelines", "ReactionOnThread", "ReactionOnTimeline", "ReactionOnVision"],
  UserCreateOrConnectWithoutSessionsInput: ["where", "create"],
  UserUpsertWithoutSessionsInput: ["update", "create"],
  UserUpdateWithoutSessionsInput: ["id", "name", "email", "emailVerified", "updatedAt", "image", "accounts", "premises", "threads", "visions", "timelines", "ReactionOnThread", "ReactionOnTimeline", "ReactionOnVision"],
  ...
  ThreadCreateWithoutAuthorInput: ["id", "title", "activityDate", "description", "createdAt", "reference", "parentThread", "childThreads", "threadsOnPremise", "threadsOnTimeline", "threadsOnVision", "ReactionOnThread"],
  ThreadCreateOrConnectWithoutAuthorInput: ["where", "create"],
  ThreadCreateManyAuthorInputEnvelope: ["data", "skipDuplicates"],
  VisionCreateWithoutAuthorInput: ["id", "title", "activityDate", "description", "updatedAt", "createdAt", "reference", "premise", "thumbnail", "draftMode", "prevVision", "nextVisions", "threadsOnVision", "mergeRequest", "ReactionOnVision"],
  VisionCreateOrConnectWithoutAuthorInput: ["where", "create"],
  VisionCreateManyAuthorInputEnvelope: ["data", "skipDuplicates"],
  TimelineCreateWithoutAuthorInput: ["id", "title", "description", "status", "premisesOnTimelines", "tagsOnTimelines", "threadsOnTimeline", "ReactionOnTimeline"],
  TimelineCreateOrConnectWithoutAuthorInput: ["where", "create"],
  TimelineCreateManyAuthorInputEnvelope: ["data", "skipDuplicates"],
  ReactionOnThreadCreateWithoutUserInput: ["id", "thread", "reaction", "createdAt"],
  ReactionOnThreadCreateOrConnectWithoutUserInput: ["where", "create"],
  ReactionOnThreadCreateManyUserInputEnvelope: ["data", "skipDuplicates"],
  ReactionOnTimelineCreateWithoutUserInput: ["id", "timeline", "reaction", "createdAt"],
  ReactionOnTimelineCreateOrConnectWithoutUserInput: ["where", "create"],
  ReactionOnTimelineCreateManyUserInputEnvelope: ["data", "skipDuplicates"],
  ReactionOnVisionCreateWithoutUserInput: ["id", "vision", "reaction", "createdAt"],
  ReactionOnVisionCreateOrConnectWithoutUserInput: ["where", "create"],
  ReactionOnVisionCreateManyUserInputEnvelope: ["data", "skipDuplicates"],
  ...
  ReactionOnThreadUpsertWithWhereUniqueWithoutUserInput: ["where", "update", "create"],
  ReactionOnThreadUpdateWithWhereUniqueWithoutUserInput: ["where", "data"],
  ReactionOnThreadUpdateManyWithWhereWithoutUserInput: ["where", "data"],
  ReactionOnThreadScalarWhereInput: ["AND", "OR", "NOT", "id", "userId", "threadId", "reaction", "createdAt"],
  ReactionOnTimelineUpsertWithWhereUniqueWithoutUserInput: ["where", "update", "create"],
  ReactionOnTimelineUpdateWithWhereUniqueWithoutUserInput: ["where", "data"],
  ReactionOnTimelineUpdateManyWithWhereWithoutUserInput: ["where", "data"],
  ReactionOnTimelineScalarWhereInput: ["AND", "OR", "NOT", "id", "userId", "timelineId", "reaction", "createdAt"],
  ReactionOnVisionUpsertWithWhereUniqueWithoutUserInput: ["where", "update", "create"],
  ReactionOnVisionUpdateWithWhereUniqueWithoutUserInput: ["where", "data"],
  ReactionOnVisionUpdateManyWithWhereWithoutUserInput: ["where", "data"],
  ReactionOnVisionScalarWhereInput: ["AND", "OR", "NOT", "id", "userId", "visionId", "reaction", "createdAt"],
  UserCreateWithoutPremisesInput: ["id", "name", "email", "emailVerified", "updatedAt", "image", "accounts", "sessions", "threads", "visions", "timelines", "ReactionOnThread", "ReactionOnTimeline", "ReactionOnVision"],
  UserCreateOrConnectWithoutPremisesInput: ["where", "create"],
  VisionCreateWithoutPremiseInput: ["id", "title", "activityDate", "description", "updatedAt", "createdAt", "reference", "author", "thumbnail", "draftMode", "prevVision", "nextVisions", "threadsOnVision", "mergeRequest", "ReactionOnVision"],
  ...
  UserUpdateWithoutPremisesInput: ["id", "name", "email", "emailVerified", "updatedAt", "image", "accounts", "sessions", "threads", "visions", "timelines", "ReactionOnThread", "ReactionOnTimeline", "ReactionOnVision"],
  ...
  UserCreateWithoutVisionsInput: ["id", "name", "email", "emailVerified", "updatedAt", "image", "accounts", "sessions", "premises", "threads", "timelines", "ReactionOnThread", "ReactionOnTimeline", "ReactionOnVision"],
  ...
  VisionCreateWithoutNextVisionsInput: ["id", "title", "activityDate", "description", "updatedAt", "createdAt", "reference", "author", "premise", "thumbnail", "draftMode", "prevVision", "threadsOnVision", "mergeRequest", "ReactionOnVision"],
  VisionCreateOrConnectWithoutNextVisionsInput: ["where", "create"],
  VisionCreateWithoutPrevVisionInput: ["id", "title", "activityDate", "description", "updatedAt", "createdAt", "reference", "author", "premise", "thumbnail", "draftMode", "nextVisions", "threadsOnVision", "mergeRequest", "ReactionOnVision"],
  ...
  ReactionOnVisionCreateWithoutVisionInput: ["id", "user", "reaction", "createdAt"],
  ReactionOnVisionCreateOrConnectWithoutVisionInput: ["where", "create"],
  ReactionOnVisionCreateManyVisionInputEnvelope: ["data", "skipDuplicates"],
  ...
  UserUpdateWithoutVisionsInput: ["id", "name", "email", "emailVerified", "updatedAt", "image", "accounts", "sessions", "premises", "threads", "timelines", "ReactionOnThread", "ReactionOnTimeline", "ReactionOnVision"],
  ...
  VisionUpdateWithoutNextVisionsInput: ["id", "title", "activityDate", "description", "updatedAt", "createdAt", "reference", "author", "premise", "thumbnail", "draftMode", "prevVision", "threadsOnVision", "mergeRequest", "ReactionOnVision"],
  ...
  ReactionOnVisionUpsertWithWhereUniqueWithoutVisionInput: ["where", "update", "create"],
  ReactionOnVisionUpdateWithWhereUniqueWithoutVisionInput: ["where", "data"],
  ReactionOnVisionUpdateManyWithWhereWithoutVisionInput: ["where", "data"],
  ...
  VisionCreateWithoutReferenceInput: ["id", "title", "activityDate", "description", "updatedAt", "createdAt", "author", "premise", "thumbnail", "draftMode", "prevVision", "nextVisions", "threadsOnVision", "mergeRequest", "ReactionOnVision"],
  ...
  VisionCreateWithoutMergeRequestInput: ["id", "title", "activityDate", "description", "updatedAt", "createdAt", "reference", "author", "premise", "thumbnail", "draftMode", "prevVision", "nextVisions", "threadsOnVision", "ReactionOnVision"],
  VisionCreateOrConnectWithoutMergeRequestInput: ["where", "create"],
  VisionUpsertWithoutMergeRequestInput: ["update", "create"],
  VisionUpdateWithoutMergeRequestInput: ["id", "title", "activityDate", "description", "updatedAt", "createdAt", "reference", "author", "premise", "thumbnail", "draftMode", "prevVision", "nextVisions", "threadsOnVision", "ReactionOnVision"],
  UserCreateWithoutTimelinesInput: ["id", "name", "email", "emailVerified", "updatedAt", "image", "accounts", "sessions", "premises", "threads", "visions", "ReactionOnThread", "ReactionOnTimeline", "ReactionOnVision"],
  ...
  ReactionOnTimelineCreateWithoutTimelineInput: ["id", "user", "reaction", "createdAt"],
  ReactionOnTimelineCreateOrConnectWithoutTimelineInput: ["where", "create"],
  ReactionOnTimelineCreateManyTimelineInputEnvelope: ["data", "skipDuplicates"],
  UserUpsertWithoutTimelinesInput: ["update", "create"],
  UserUpdateWithoutTimelinesInput: ["id", "name", "email", "emailVerified", "updatedAt", "image", "accounts", "sessions", "premises", "threads", "visions", "ReactionOnThread", "ReactionOnTimeline", "ReactionOnVision"],
  ...
  ReactionOnTimelineUpsertWithWhereUniqueWithoutTimelineInput: ["where", "update", "create"],
  ReactionOnTimelineUpdateWithWhereUniqueWithoutTimelineInput: ["where", "data"],
  ReactionOnTimelineUpdateManyWithWhereWithoutTimelineInput: ["where", "data"],
  ...
  TimelineCreateWithoutTagsOnTimelinesInput: ["id", "title", "description", "status", "author", "premisesOnTimelines", "threadsOnTimeline", "ReactionOnTimeline"],
  ...
  TimelineUpdateWithoutTagsOnTimelinesInput: ["id", "title", "description", "status", "author", "premisesOnTimelines", "threadsOnTimeline", "ReactionOnTimeline"],
  TimelineCreateWithoutPremisesOnTimelinesInput: ["id", "title", "description", "status", "author", "tagsOnTimelines", "threadsOnTimeline", "ReactionOnTimeline"],
  ...
  TimelineUpdateWithoutPremisesOnTimelinesInput: ["id", "title", "description", "status", "author", "tagsOnTimelines", "threadsOnTimeline", "ReactionOnTimeline"],
  ...
  UserCreateWithoutThreadsInput: ["id", "name", "email", "emailVerified", "updatedAt", "image", "accounts", "sessions", "premises", "visions", "timelines", "ReactionOnThread", "ReactionOnTimeline", "ReactionOnVision"],
  UserCreateOrConnectWithoutThreadsInput: ["where", "create"],
  ThreadCreateWithoutChildThreadsInput: ["id", "title", "activityDate", "description", "createdAt", "reference", "author", "parentThread", "threadsOnPremise", "threadsOnTimeline", "threadsOnVision", "ReactionOnThread"],
  ThreadCreateOrConnectWithoutChildThreadsInput: ["where", "create"],
  ThreadCreateWithoutParentThreadInput: ["id", "title", "activityDate", "description", "createdAt", "reference", "author", "childThreads", "threadsOnPremise", "threadsOnTimeline", "threadsOnVision", "ReactionOnThread"],
  ...
  ReactionOnThreadCreateWithoutThreadInput: ["id", "user", "reaction", "createdAt"],
  ReactionOnThreadCreateOrConnectWithoutThreadInput: ["where", "create"],
  ReactionOnThreadCreateManyThreadInputEnvelope: ["data", "skipDuplicates"],
  UserUpsertWithoutThreadsInput: ["update", "create"],
  UserUpdateWithoutThreadsInput: ["id", "name", "email", "emailVerified", "updatedAt", "image", "accounts", "sessions", "premises", "visions", "timelines", "ReactionOnThread", "ReactionOnTimeline", "ReactionOnVision"],
  ThreadUpsertWithoutChildThreadsInput: ["update", "create"],
  ThreadUpdateWithoutChildThreadsInput: ["id", "title", "activityDate", "description", "createdAt", "reference", "author", "parentThread", "threadsOnPremise", "threadsOnTimeline", "threadsOnVision", "ReactionOnThread"],
  ...
  ReactionOnThreadUpsertWithWhereUniqueWithoutThreadInput: ["where", "update", "create"],
  ReactionOnThreadUpdateWithWhereUniqueWithoutThreadInput: ["where", "data"],
  ReactionOnThreadUpdateManyWithWhereWithoutThreadInput: ["where", "data"],
  ThreadCreateWithoutThreadsOnPremiseInput: ["id", "title", "activityDate", "description", "createdAt", "reference", "author", "parentThread", "childThreads", "threadsOnTimeline", "threadsOnVision", "ReactionOnThread"],
  ...
  ThreadUpdateWithoutThreadsOnPremiseInput: ["id", "title", "activityDate", "description", "createdAt", "reference", "author", "parentThread", "childThreads", "threadsOnTimeline", "threadsOnVision", "ReactionOnThread"],
  ...
  ThreadCreateWithoutThreadsOnTimelineInput: ["id", "title", "activityDate", "description", "createdAt", "reference", "author", "parentThread", "childThreads", "threadsOnPremise", "threadsOnVision", "ReactionOnThread"],
  ThreadCreateOrConnectWithoutThreadsOnTimelineInput: ["where", "create"],
  TimelineCreateWithoutThreadsOnTimelineInput: ["id", "title", "description", "status", "author", "premisesOnTimelines", "tagsOnTimelines", "ReactionOnTimeline"],
  TimelineCreateOrConnectWithoutThreadsOnTimelineInput: ["where", "create"],
  ThreadUpsertWithoutThreadsOnTimelineInput: ["update", "create"],
  ThreadUpdateWithoutThreadsOnTimelineInput: ["id", "title", "activityDate", "description", "createdAt", "reference", "author", "parentThread", "childThreads", "threadsOnPremise", "threadsOnVision", "ReactionOnThread"],
  TimelineUpsertWithoutThreadsOnTimelineInput: ["update", "create"],
  TimelineUpdateWithoutThreadsOnTimelineInput: ["id", "title", "description", "status", "author", "premisesOnTimelines", "tagsOnTimelines", "ReactionOnTimeline"],
  UserCreateWithoutReactionOnThreadInput: ["id", "name", "email", "emailVerified", "updatedAt", "image", "accounts", "sessions", "premises", "threads", "visions", "timelines", "ReactionOnTimeline", "ReactionOnVision"],
  UserCreateOrConnectWithoutReactionOnThreadInput: ["where", "create"],
  ThreadCreateWithoutReactionOnThreadInput: ["id", "title", "activityDate", "description", "createdAt", "reference", "author", "parentThread", "childThreads", "threadsOnPremise", "threadsOnTimeline", "threadsOnVision"],
  ThreadCreateOrConnectWithoutReactionOnThreadInput: ["where", "create"],
  UserUpsertWithoutReactionOnThreadInput: ["update", "create"],
  UserUpdateWithoutReactionOnThreadInput: ["id", "name", "email", "emailVerified", "updatedAt", "image", "accounts", "sessions", "premises", "threads", "visions", "timelines", "ReactionOnTimeline", "ReactionOnVision"],
  ThreadUpsertWithoutReactionOnThreadInput: ["update", "create"],
  ThreadUpdateWithoutReactionOnThreadInput: ["id", "title", "activityDate", "description", "createdAt", "reference", "author", "parentThread", "childThreads", "threadsOnPremise", "threadsOnTimeline", "threadsOnVision"],
  UserCreateWithoutReactionOnTimelineInput: ["id", "name", "email", "emailVerified", "updatedAt", "image", "accounts", "sessions", "premises", "threads", "visions", "timelines", "ReactionOnThread", "ReactionOnVision"],
  UserCreateOrConnectWithoutReactionOnTimelineInput: ["where", "create"],
  TimelineCreateWithoutReactionOnTimelineInput: ["id", "title", "description", "status", "author", "premisesOnTimelines", "tagsOnTimelines", "threadsOnTimeline"],
  TimelineCreateOrConnectWithoutReactionOnTimelineInput: ["where", "create"],
  UserUpsertWithoutReactionOnTimelineInput: ["update", "create"],
  UserUpdateWithoutReactionOnTimelineInput: ["id", "name", "email", "emailVerified", "updatedAt", "image", "accounts", "sessions", "premises", "threads", "visions", "timelines", "ReactionOnThread", "ReactionOnVision"],
  TimelineUpsertWithoutReactionOnTimelineInput: ["update", "create"],
  TimelineUpdateWithoutReactionOnTimelineInput: ["id", "title", "description", "status", "author", "premisesOnTimelines", "tagsOnTimelines", "threadsOnTimeline"],
  UserCreateWithoutReactionOnVisionInput: ["id", "name", "email", "emailVerified", "updatedAt", "image", "accounts", "sessions", "premises", "threads", "visions", "timelines", "ReactionOnThread", "ReactionOnTimeline"],
  UserCreateOrConnectWithoutReactionOnVisionInput: ["where", "create"],
  VisionCreateWithoutReactionOnVisionInput: ["id", "title", "activityDate", "description", "updatedAt", "createdAt", "reference", "author", "premise", "thumbnail", "draftMode", "prevVision", "nextVisions", "threadsOnVision", "mergeRequest"],
  VisionCreateOrConnectWithoutReactionOnVisionInput: ["where", "create"],
  UserUpsertWithoutReactionOnVisionInput: ["update", "create"],
  UserUpdateWithoutReactionOnVisionInput: ["id", "name", "email", "emailVerified", "updatedAt", "image", "accounts", "sessions", "premises", "threads", "visions", "timelines", "ReactionOnThread", "ReactionOnTimeline"],
  VisionUpsertWithoutReactionOnVisionInput: ["update", "create"],
  VisionUpdateWithoutReactionOnVisionInput: ["id", "title", "activityDate", "description", "updatedAt", "createdAt", "reference", "author", "premise", "thumbnail", "draftMode", "prevVision", "nextVisions", "threadsOnVision", "mergeRequest"],
  ThreadCreateWithoutThreadsOnVisionInput: ["id", "title", "activityDate", "description", "createdAt", "reference", "author", "parentThread", "childThreads", "threadsOnPremise", "threadsOnTimeline", "ReactionOnThread"],
  ThreadCreateOrConnectWithoutThreadsOnVisionInput: ["where", "create"],
  VisionCreateWithoutThreadsOnVisionInput: ["id", "title", "activityDate", "description", "updatedAt", "createdAt", "reference", "author", "premise", "thumbnail", "draftMode", "prevVision", "nextVisions", "mergeRequest", "ReactionOnVision"],
  VisionCreateOrConnectWithoutThreadsOnVisionInput: ["where", "create"],
  ThreadUpsertWithoutThreadsOnVisionInput: ["update", "create"],
  ThreadUpdateWithoutThreadsOnVisionInput: ["id", "title", "activityDate", "description", "createdAt", "reference", "author", "parentThread", "childThreads", "threadsOnPremise", "threadsOnTimeline", "ReactionOnThread"],
  VisionUpsertWithoutThreadsOnVisionInput: ["update", "create"],
  VisionUpdateWithoutThreadsOnVisionInput: ["id", "title", "activityDate", "description", "updatedAt", "createdAt", "reference", "author", "premise", "thumbnail", "draftMode", "prevVision", "nextVisions", "mergeRequest", "ReactionOnVision"],
  ...
  ReactionOnThreadCreateManyUserInput: ["id", "threadId", "reaction", "createdAt"],
  ReactionOnTimelineCreateManyUserInput: ["id", "timelineId", "reaction", "createdAt"],
  ReactionOnVisionCreateManyUserInput: ["id", "visionId", "reaction", "createdAt"],
  ...
  ThreadUpdateWithoutAuthorInput: ["id", "title", "activityDate", "description", "createdAt", "reference", "parentThread", "childThreads", "threadsOnPremise", "threadsOnTimeline", "threadsOnVision", "ReactionOnThread"],
  VisionUpdateWithoutAuthorInput: ["id", "title", "activityDate", "description", "updatedAt", "createdAt", "reference", "premise", "thumbnail", "draftMode", "prevVision", "nextVisions", "threadsOnVision", "mergeRequest", "ReactionOnVision"],
  TimelineUpdateWithoutAuthorInput: ["id", "title", "description", "status", "premisesOnTimelines", "tagsOnTimelines", "threadsOnTimeline", "ReactionOnTimeline"],
  ReactionOnThreadUpdateWithoutUserInput: ["id", "thread", "reaction", "createdAt"],
  ReactionOnTimelineUpdateWithoutUserInput: ["id", "timeline", "reaction", "createdAt"],
  ReactionOnVisionUpdateWithoutUserInput: ["id", "vision", "reaction", "createdAt"],
  ...
  VisionUpdateWithoutPremiseInput: ["id", "title", "activityDate", "description", "updatedAt", "createdAt", "reference", "author", "thumbnail", "draftMode", "prevVision", "nextVisions", "threadsOnVision", "mergeRequest", "ReactionOnVision"],
  ...
  ReactionOnVisionCreateManyVisionInput: ["id", "userId", "reaction", "createdAt"],
  VisionUpdateWithoutPrevVisionInput: ["id", "title", "activityDate", "description", "updatedAt", "createdAt", "reference", "author", "premise", "thumbnail", "draftMode", "nextVisions", "threadsOnVision", "mergeRequest", "ReactionOnVision"],
  ThreadsOnVisionUpdateWithoutVisionInput: ["thread", "assignedAt"],
  ReactionOnVisionUpdateWithoutVisionInput: ["id", "user", "reaction", "createdAt"],
  ...
  VisionUpdateWithoutReferenceInput: ["id", "title", "activityDate", "description", "updatedAt", "createdAt", "author", "premise", "thumbnail", "draftMode", "prevVision", "nextVisions", "threadsOnVision", "mergeRequest", "ReactionOnVision"],
  ...
  ReactionOnTimelineCreateManyTimelineInput: ["id", "userId", "reaction", "createdAt"],
  ...
  ReactionOnTimelineUpdateWithoutTimelineInput: ["id", "user", "reaction", "createdAt"],
  ...
  ReactionOnThreadCreateManyThreadInput: ["id", "userId", "reaction", "createdAt"],
  ThreadUpdateWithoutParentThreadInput: ["id", "title", "activityDate", "description", "createdAt", "reference", "author", "childThreads", "threadsOnPremise", "threadsOnTimeline", "threadsOnVision", "ReactionOnThread"],
  ReactionOnThreadUpdateWithoutThreadInput: ["id", "user", "reaction", "createdAt"]
};
