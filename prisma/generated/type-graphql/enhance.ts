...
const relationResolversInfo = {
  Account: ["user"],
  Session: ["user"],
  User: ["accounts", "sessions", "premises", "threads", "visions", "timelines"],
  Premise: ["author", "vision", "premisesOnTimelines", "tagsOnPremises", "threadsOnPremise"],
  Vision: ["reference", "author", "premise", "prevVision", "nextVisions", "threadsOnVision", "mergeRequest"],
...
const modelsInfo = {
  ...
  Vision: ["id", "title", "activityDate", "description", "createdAt", "referenceId", "authorId", "thumbnail", "premiseId", "draftMode", "prevVisionId"],
  Reference: ["id"],
...
const outputsInfo = {
  ...
  VisionGroupBy: ["id", "title", "activityDate", "description", "createdAt", "referenceId", "authorId", "thumbnail", "premiseId", "draftMode", "prevVisionId", "_count", "_min", "_max"],
  ...
  UserCount: ["accounts", "sessions", "premises", "threads", "visions", "timelines"],
  ...
  VisionCount: ["nextVisions", "threadsOnVision"],
  VisionCountAggregate: ["id", "title", "activityDate", "description", "createdAt", "referenceId", "authorId", "thumbnail", "premiseId", "draftMode", "prevVisionId", "_all"],
  VisionMinAggregate: ["id", "title", "activityDate", "description", "createdAt", "referenceId", "authorId", "thumbnail", "premiseId", "draftMode", "prevVisionId"],
  VisionMaxAggregate: ["id", "title", "activityDate", "description", "createdAt", "referenceId", "authorId", "thumbnail", "premiseId", "draftMode", "prevVisionId"],
...
const inputsInfo = {
  ...
  UserWhereInput: ["AND", "OR", "NOT", "id", "name", "email", "emailVerified", "image", "accounts", "sessions", "premises", "threads", "visions", "timelines"],
  UserOrderByWithRelationInput: ["id", "name", "email", "emailVerified", "image", "accounts", "sessions", "premises", "threads", "visions", "timelines"],
  ...
  VisionWhereInput: ["AND", "OR", "NOT", "id", "title", "activityDate", "description", "createdAt", "reference", "referenceId", "author", "authorId", "premise", "thumbnail", "premiseId", "draftMode", "prevVisionId", "prevVision", "nextVisions", "threadsOnVision", "mergeRequest"],
  VisionOrderByWithRelationInput: ["id", "title", "activityDate", "description", "createdAt", "reference", "referenceId", "author", "authorId", "premise", "thumbnail", "premiseId", "draftMode", "prevVisionId", "prevVision", "nextVisions", "threadsOnVision", "mergeRequest"],
  VisionWhereUniqueInput: ["id"],
  VisionOrderByWithAggregationInput: ["id", "title", "activityDate", "description", "createdAt", "referenceId", "authorId", "thumbnail", "premiseId", "draftMode", "prevVisionId", "_count", "_max", "_min"],
  VisionScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "title", "activityDate", "description", "createdAt", "referenceId", "authorId", "thumbnail", "premiseId", "draftMode", "prevVisionId"],
  ...
  UserCreateInput: ["id", "name", "email", "emailVerified", "image", "accounts", "sessions", "premises", "threads", "visions", "timelines"],
  UserUpdateInput: ["id", "name", "email", "emailVerified", "image", "accounts", "sessions", "premises", "threads", "visions", "timelines"],
  ...
  VisionCreateInput: ["id", "title", "activityDate", "description", "createdAt", "reference", "author", "premise", "thumbnail", "draftMode", "prevVision", "nextVisions", "threadsOnVision", "mergeRequest"],
  VisionUpdateInput: ["id", "title", "activityDate", "description", "createdAt", "reference", "author", "premise", "thumbnail", "draftMode", "prevVision", "nextVisions", "threadsOnVision", "mergeRequest"],
  VisionCreateManyInput: ["id", "title", "activityDate", "description", "createdAt", "referenceId", "authorId", "thumbnail", "premiseId", "draftMode", "prevVisionId"],
  VisionUpdateManyMutationInput: ["id", "title", "activityDate", "description", "createdAt", "thumbnail", "draftMode"],
  ...
  VisionCountOrderByAggregateInput: ["id", "title", "activityDate", "description", "createdAt", "referenceId", "authorId", "thumbnail", "premiseId", "draftMode", "prevVisionId"],
  VisionMaxOrderByAggregateInput: ["id", "title", "activityDate", "description", "createdAt", "referenceId", "authorId", "thumbnail", "premiseId", "draftMode", "prevVisionId"],
  VisionMinOrderByAggregateInput: ["id", "title", "activityDate", "description", "createdAt", "referenceId", "authorId", "thumbnail", "premiseId", "draftMode", "prevVisionId"],
  ...
  UserCreateWithoutAccountsInput: ["id", "name", "email", "emailVerified", "image", "sessions", "premises", "threads", "visions", "timelines"],
  UserCreateOrConnectWithoutAccountsInput: ["where", "create"],
  UserUpsertWithoutAccountsInput: ["update", "create"],
  UserUpdateWithoutAccountsInput: ["id", "name", "email", "emailVerified", "image", "sessions", "premises", "threads", "visions", "timelines"],
  UserCreateWithoutSessionsInput: ["id", "name", "email", "emailVerified", "image", "accounts", "premises", "threads", "visions", "timelines"],
  UserCreateOrConnectWithoutSessionsInput: ["where", "create"],
  UserUpsertWithoutSessionsInput: ["update", "create"],
  UserUpdateWithoutSessionsInput: ["id", "name", "email", "emailVerified", "image", "accounts", "premises", "threads", "visions", "timelines"],
  ...
  VisionCreateWithoutAuthorInput: ["id", "title", "activityDate", "description", "createdAt", "reference", "premise", "thumbnail", "draftMode", "prevVision", "nextVisions", "threadsOnVision", "mergeRequest"],
  ...
  VisionScalarWhereInput: ["AND", "OR", "NOT", "id", "title", "activityDate", "description", "createdAt", "referenceId", "authorId", "thumbnail", "premiseId", "draftMode", "prevVisionId"],
  ...
  UserCreateWithoutPremisesInput: ["id", "name", "email", "emailVerified", "image", "accounts", "sessions", "threads", "visions", "timelines"],
  UserCreateOrConnectWithoutPremisesInput: ["where", "create"],
  VisionCreateWithoutPremiseInput: ["id", "title", "activityDate", "description", "createdAt", "reference", "author", "thumbnail", "draftMode", "prevVision", "nextVisions", "threadsOnVision", "mergeRequest"],
  ...
  UserUpdateWithoutPremisesInput: ["id", "name", "email", "emailVerified", "image", "accounts", "sessions", "threads", "visions", "timelines"],
  ...
  UserCreateWithoutVisionsInput: ["id", "name", "email", "emailVerified", "image", "accounts", "sessions", "premises", "threads", "timelines"],
  ...
  VisionCreateWithoutNextVisionsInput: ["id", "title", "activityDate", "description", "createdAt", "reference", "author", "premise", "thumbnail", "draftMode", "prevVision", "threadsOnVision", "mergeRequest"],
  VisionCreateOrConnectWithoutNextVisionsInput: ["where", "create"],
  VisionCreateWithoutPrevVisionInput: ["id", "title", "activityDate", "description", "createdAt", "reference", "author", "premise", "thumbnail", "draftMode", "nextVisions", "threadsOnVision", "mergeRequest"],
  ...
  UserUpdateWithoutVisionsInput: ["id", "name", "email", "emailVerified", "image", "accounts", "sessions", "premises", "threads", "timelines"],
  ...
  VisionUpdateWithoutNextVisionsInput: ["id", "title", "activityDate", "description", "createdAt", "reference", "author", "premise", "thumbnail", "draftMode", "prevVision", "threadsOnVision", "mergeRequest"],
  ...
  VisionCreateWithoutReferenceInput: ["id", "title", "activityDate", "description", "createdAt", "author", "premise", "thumbnail", "draftMode", "prevVision", "nextVisions", "threadsOnVision", "mergeRequest"],
  ...
  VisionCreateWithoutMergeRequestInput: ["id", "title", "activityDate", "description", "createdAt", "reference", "author", "premise", "thumbnail", "draftMode", "prevVision", "nextVisions", "threadsOnVision"],
  VisionCreateOrConnectWithoutMergeRequestInput: ["where", "create"],
  VisionUpsertWithoutMergeRequestInput: ["update", "create"],
  VisionUpdateWithoutMergeRequestInput: ["id", "title", "activityDate", "description", "createdAt", "reference", "author", "premise", "thumbnail", "draftMode", "prevVision", "nextVisions", "threadsOnVision"],
  UserCreateWithoutTimelinesInput: ["id", "name", "email", "emailVerified", "image", "accounts", "sessions", "premises", "threads", "visions"],
  ...
  UserUpdateWithoutTimelinesInput: ["id", "name", "email", "emailVerified", "image", "accounts", "sessions", "premises", "threads", "visions"],
  ...
  UserCreateWithoutThreadsInput: ["id", "name", "email", "emailVerified", "image", "accounts", "sessions", "premises", "visions", "timelines"],
  ...
  UserUpdateWithoutThreadsInput: ["id", "name", "email", "emailVerified", "image", "accounts", "sessions", "premises", "visions", "timelines"],
  ...
  VisionCreateWithoutThreadsOnVisionInput: ["id", "title", "activityDate", "description", "createdAt", "reference", "author", "premise", "thumbnail", "draftMode", "prevVision", "nextVisions", "mergeRequest"],
  ...
  VisionUpdateWithoutThreadsOnVisionInput: ["id", "title", "activityDate", "description", "createdAt", "reference", "author", "premise", "thumbnail", "draftMode", "prevVision", "nextVisions", "mergeRequest"],
  ...
  VisionCreateManyAuthorInput: ["id", "title", "activityDate", "description", "createdAt", "referenceId", "thumbnail", "premiseId", "draftMode", "prevVisionId"],
  ...
  VisionUpdateWithoutAuthorInput: ["id", "title", "activityDate", "description", "createdAt", "reference", "premise", "thumbnail", "draftMode", "prevVision", "nextVisions", "threadsOnVision", "mergeRequest"],
  TimelineUpdateWithoutAuthorInput: ["id", "title", "description", "status", "premisesOnTimelines", "tagsOnTimelines", "threadsOnTimeline"],
  VisionCreateManyPremiseInput: ["id", "title", "activityDate", "description", "createdAt", "referenceId", "authorId", "thumbnail", "draftMode", "prevVisionId"],
  ...
  VisionUpdateWithoutPremiseInput: ["id", "title", "activityDate", "description", "createdAt", "reference", "author", "thumbnail", "draftMode", "prevVision", "nextVisions", "threadsOnVision", "mergeRequest"],
  ...
  VisionCreateManyPrevVisionInput: ["id", "title", "activityDate", "description", "createdAt", "referenceId", "authorId", "thumbnail", "premiseId", "draftMode"],
  ThreadsOnVisionCreateManyVisionInput: ["threadId", "assignedAt"],
  VisionUpdateWithoutPrevVisionInput: ["id", "title", "activityDate", "description", "createdAt", "reference", "author", "premise", "thumbnail", "draftMode", "nextVisions", "threadsOnVision", "mergeRequest"],
  ThreadsOnVisionUpdateWithoutVisionInput: ["thread", "assignedAt"],
  VisionCreateManyReferenceInput: ["id", "title", "activityDate", "description", "createdAt", "authorId", "thumbnail", "premiseId", "draftMode", "prevVisionId"],
  SnapshotUpdateWithoutReferencesInput: ["id", "createdAt", "versionId", "s3Url", "sourceUrl", "caption"],
  VisionUpdateWithoutReferenceInput: ["id", "title", "activityDate", "description", "createdAt", "author", "premise", "thumbnail", "draftMode", "prevVision", "nextVisions", "threadsOnVision", "mergeRequest"],
